            ...
            <div className="flex flex-col gap-2">
              {navLinks.map((link, idx) => (
                <motion.a
                  ...
                  className="px-4 py-3 text-sm font-sans font-medium text-[#1E1E1E] hover:text-[#B8955D] hover:bg-[#B8955D]/10 rounded-xl transition-all duration-200 flex items-center justify-between"
                >
                  <span>{link.name}</span>
