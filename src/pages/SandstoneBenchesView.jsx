...
const HERO_IMG = "/img/product/Stone Products/Sandstone Benches/image.png";
const TEXTURE_IMG = "/img/product/Stone Products/Sandstone Benches/image copy.png";
const CTA_IMG = "/img/product/Stone Products/Sandstone Benches/image copy 3.png";
...
const galleryImages = [
  "/img/product/Stone Products/Sandstone Benches/image.png",
  "/img/product/Stone Products/Sandstone Benches/image copy.png",
  "/img/product/Stone Products/Sandstone Benches/image copy 2.png",
  "/img/product/Stone Products/Sandstone Benches/image copy 3.png",
];

const featuresList = [
  { text: "Accurate shape and size" },
  { text: "Stunning look & supreme finish" },
  { text: "Beautiful designs" },
  { text: "Withstand heat and water" },
  { text: "Robustness and sturdy design" },
];

const applicationsList = [
  { text: "Gardens & lawns" },
  { text: "Outdoor seating areas" },
  { text: "Public parks & landscaping" },
  { text: "Home exterior decor" },
];

const steps = [
  { title: "Professional Crafting", body: "Our skilled craftsmen follow the latest market trends and utilize modern modeling methods." },
  { title: "Premium Quality", body: "We use high-end tools to craft Madhya Pradesh Sandstone Benches with a durable structure." },
  { title: "Weather Resistance", body: "Our sandstone benches are resistant to adverse climatic conditions, withstanding heat and water." },
  { title: "Tailored Elegance", body: "Offering high aesthetic appeal, custom design flexibility, and smooth edges for a royal look." },
];

const LENS_SIZE = 180;
const ZOOM = 2.4;

const SandstoneBenchesView = () => {
    ...
    <div ref={pageRef} className="bg-[#FAFAF8] min-h-[100svh] font-sans text-[#111]">
      ...
      <div className="bg-[#FAFAF8] border-b border-[#EDEDE9] py-4 sticky top-0 z-40 backdrop-blur-xl bg-[#FAFAF8]/90">
        <div className="max-w-7xl mx-auto px-6 flex items-center gap-2 text-xs font-mono uppercase tracking-widest text-[#888]">
          ...
          <ChevronRight size={12} />
          <span className="text-[#B8955D] font-bold">Sandstone Benches</span>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-6">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              Stone India has earned a reputed position in offering Gwalior Sandstone benches made from premium quality marble. Our professional and skilled craftsmen follow the latest market trends. The benches feature high aesthetic appeal, beautiful look, attractive design, and smooth edges. Moreover, they can also be customized in the required designs and finishes.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              We use high-end tools and latest modeling methods to craft Madhya Pradesh Sandstone Benches. They are highly renowned for offering glossy finish, beautiful appearance, and durable structure. Our widespread industry also supports an initiative to provide qualitative solutions to our customers. The benches are elegantly designed, easy to maintain, and available at competitive prices.
            </p>
            <div className="pt-4">
      ...
      <section id="patterns" className="reveal-block py-20 sm:py-28 px-6 bg-[#FAFAF8]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-8">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              Our whole range of sandstone benches available in India are resistant to adverse climatic conditions and are delivered in the standard range. They retain their finish for a long time and are exceptionally easy to maintain.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              With the assistance of our experienced professionals, we offer an exceptional product range. They are widely appreciated for their enchanting designs, supreme finish, and uniqueness. The demands for these benches are increasing owing to their high quality, durability, and robustness. So give your place a royal look with a blend of nature.
            </p>
          ...
          <div className="split-right relative aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl">
            <img src={galleryImages[1]} alt="Sandstone Benches Royal Design" className="w-full h-full object-cover" onLoad={(e) => {
            ...
            <div className="absolute bottom-10 left-10 right-10 pointer-events-none">
              <h3 className="text-white font-serif text-3xl mb-3">Royal Look</h3>
              <p className="text-white/80 font-light text-sm">Give your outdoor space a blend of nature and durable elegance.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center reveal-block">
          <div className="split-left">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light mb-5">
              Hover over the sandstone bench to inspect the smooth edges, glossy finish, and accurate shape up close. Witness the sturdy design crafted to withstand heat and water.
            </p>
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 border-t border-black/[0.08]">
            {stoneProductsData.stoneArticrafts
              .filter(item => item.title !== "Sandstone Benches")
              .map((item, idx) => (
              <Link
                key={idx}
...
export default SandstoneBenchesView;
