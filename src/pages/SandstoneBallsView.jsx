...
const HERO_IMG = "/img/product/Stone Products/Sandstone Balls/image.png";
const TEXTURE_IMG = "/img/product/Stone Products/Sandstone Balls/image copy.png";
const CTA_IMG = "/img/product/Stone Products/Sandstone Balls/image copy 2.png";
...
const galleryImages = [
  "/img/product/Stone Products/Sandstone Balls/image.png",
  "/img/product/Stone Products/Sandstone Balls/image copy.png",
  "/img/product/Stone Products/Sandstone Balls/image copy 2.png",
  "/img/product/Stone Products/Sandstone Balls/image.png",
];

const featuresList = [
  { text: "Good for decoration" },
  { text: "Enhances overall ambience" },
  { text: "Wide range of colors" },
  { text: "Crack and stain resistant" },
  { text: "Reliability" },
];

const applicationsList = [
  { text: "Lawn decoration" },
  { text: "Garden centerpieces" },
  { text: "Walkway accents" },
  { text: "Custom landscaping" },
];

const steps = [
  { title: "Material Selection", body: "We select the highest quality sandstone, ensuring it offers excellent durability and crack resistance." },
  { title: "Precision Crafting", body: "Our commitment to excellence translates into the best manufacturing practices to deliver highly dynamic balls." },
  { title: "Stain Resistance", body: "We ensure our sandstone balls possess high resistance to stains and weather impacts for longevity." },
  { title: "Quality Assurance", body: "Our exacting quality standards ensure we deliver products that surpass the expectations of our clients." },
];

const LENS_SIZE = 180;
const ZOOM = 2.4;

const SandstoneBallsView = () => {
    ...
    <div ref={pageRef} className="bg-[#FAFAF8] min-h-[100svh] font-sans text-[#111]">
      ...
      <section className="relative h-[100svh] min-h-[500px] sm:min-h-[600px] w-full overflow-hidden bg-[#111]">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-end sm:justify-center text-center px-4 sm:px-6 pb-20 sm:pb-0 max-w-5xl mx-auto">
          ...
          <p ref={heroSubRef} className="opacity-0 text-sm sm:text-lg md:text-2xl text-white/80 font-light max-w-2xl mx-auto leading-relaxed mb-6 sm:mb-10">
            Highly dynamic sandstone balls offering an elegant design that enhances the overall ambiance of any outdoor space.
          </p>
      ...
      <div className="bg-[#FAFAF8] border-b border-[#EDEDE9] py-4 sticky top-0 z-40 backdrop-blur-xl bg-[#FAFAF8]/90">
        <div className="max-w-7xl mx-auto px-6 flex items-center gap-2 text-xs font-mono uppercase tracking-widest text-[#888]">
          ...
          <ChevronRight size={12} />
          <span className="text-[#B8955D] font-bold">Sandstone Balls</span>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-6">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              Our status as a renowned sandstone ball manufacturer and supplier motivates us to offer the best products that surpass the expectations of our clients. Our commitment to excellence is unquestionable and we make use of the best manufacturing practices to deliver highly dynamic sandstone balls.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              These products are mainly used on the lawns for decorative purposes and the elegant design enhances the overall ambiance in an unprecedented manner. Fine finish and attractive look are two important features of our products and our years of experience in the industry have helped us understand the customer psychology better than any competitor.
            </p>
            <div className="pt-4">
      ...
      <section id="patterns" className="reveal-block py-20 sm:py-28 px-6 bg-[#FAFAF8]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-8">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              You can find our products in varied sizes and designs and the crack-resistant nature of our products has won a lot of appreciation from our customers. High resistance to stain is an added benefit and most of the balls are available in lively colors.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              It can be said without an iota of doubt that our rich selection of colors and exacting quality standards have played a prominent role in making us the most reliable sandstone ball manufacturers.
            </p>
          ...
          <div className="split-right relative aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl">
            <img src={galleryImages[1]} alt="Sandstone Balls Decor" className="w-full h-full object-cover" onLoad={(e) => {
            ...
            <div className="absolute bottom-10 left-10 right-10 pointer-events-none">
              <h3 className="text-white font-serif text-3xl mb-3">Lively Ambience</h3>
              <p className="text-white/80 font-light text-sm">Elegant designs that enhance overall outdoor atmosphere.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center reveal-block">
          <div className="split-left">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light mb-5">
              Hover over the sandstone ball to inspect the fine finish and beautiful texture up close. Experience the premium quality that makes our natural stone highly resistant to cracks and stains.
            </p>
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 border-t border-black/[0.08]">
            {stoneProductsData.stoneArticrafts
              .filter(item => item.title !== "Sandstone Balls")
              .map((item, idx) => (
              <Link
                key={idx}
      ...
      <section id="contact" className="relative py-32 flex items-center justify-center overflow-hidden bg-[#111]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center flex flex-col items-center">
          ...
          <p className="text-lg md:text-xl text-white/70 font-light max-w-2xl mx-auto mb-10 leading-relaxed">
            Beautifully crafted natural sandstone balls available in bulk for wholesale buyers globally. Upgrade your lawns and gardens with our elegant centerpieces.
          </p>
...
export default SandstoneBallsView;
