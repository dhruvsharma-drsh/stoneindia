// src/pages/SagarBlackSandstoneView.jsx
...
const HERO_IMG = "/img/product/Stone Products/Sagar Black sandstone/Sagar-Black-sandstone.webp";
...
const patterns = [
  { name: "Pattern 1", stone: "Sagar Black", img: "/img/product/Stone Products/Sagar Black sandstone/Patterns/Sagar-Black-sandstone-03.webp", desc: "Exquisite dark finish for a modern aesthetic.", swatch: "#2A2A2A", type: "Natural", complexity: "High", bestFor: "Exterior Paving" },
  { name: "Pattern 2", stone: "Sagar Black", img: "/img/product/Stone Products/Sagar Black sandstone/Patterns/Sagar-Black-sandstone-04.webp", desc: "Durable and weather resistant dark stone.", swatch: "#333333", type: "Split Surface", complexity: "Medium", bestFor: "Driveways" },
  { name: "Pattern 3", stone: "Sagar Black", img: "/img/product/Stone Products/Sagar Black sandstone/Patterns/Sagar-black-sand-stone-5.jpg", desc: "Minimal maintenance with maximum impact.", swatch: "#1F1F1F", type: "Natural", complexity: "Low", bestFor: "Patio Floors" },
  { name: "Pattern 4", stone: "Sagar Black", img: "/img/product/Stone Products/Sagar Black sandstone/Patterns/Sagar-black-sand-stone-6.webp", desc: "Saline water resistant for specialized areas.", swatch: "#3B3B3B", type: "Polished", complexity: "High", bestFor: "Pool Sides" },
  { name: "Pattern 5", stone: "Sagar Black", img: "/img/product/Stone Products/Sagar Black sandstone/Patterns/Sagar-black-sand-stone-7.webp", desc: "Highly durable with excellent mechanical strength.", swatch: "#262626", type: "Shot Blasted", complexity: "Medium", bestFor: "Walkways" }
];

const MARBLE_TEXTURE = patterns[0].img;

const galleryImages = [
  "/img/product/Stone Products/Sagar Black sandstone/Sagar-Black-sandstone-02.webp",
  "/img/product/Stone Products/Sagar Black sandstone/Sagar-black-sand-stone-1.webp",
  "/img/product/Stone Products/Sagar Black sandstone/Sagar-black-sand-stone-2.webp",
  "/img/product/Stone Products/Sagar Black sandstone/Sagar-black-sand-stone-3.webp",
  "/img/product/Stone Products/Sagar Black sandstone/Sagar-black-sand-stone-4.webp",
  "/img/product/Stone Products/Sagar Black sandstone/Patterns/Sagar-Black-sandstone-03.webp"
];

const steps = [
  { title: "Superior Blocks", body: "Our stones are fabricated with the help of superior quality blocks." },
  { title: "Simple Installation", body: "The installation process is extremely simple for added convenience." },
  { title: "Strict Quality Checks", body: "We conduct frequent strict quality checks to maintain high standards." },
  { title: "Commitment", body: "We deliver everything you need with utmost commitment and responsibility." },
];

const LENS_SIZE = 180;
const ZOOM = 2.4;

const SagarBlackSandstoneView = () => {
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-6">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              STONE INDIA, Sagar black sandstone are extremely popular in the industry for their quality and durability. We offer an exquisite range of stones and they are available in a wide variety of patterns and blocks. The popularity of our products in the national and international markets makes us really proud and we are deeply committed to meet the requirements of our clients in the best possible manner.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              Our stones are fabricated with the help of superior quality blocks and the installation process is extremely simple. When it comes to maintenance, you can relax a lot because they demand only minimal maintenance. The variety offered by us is simply amazing and all our products are highly durable and affordable as well.
            </p>
            <div className="pt-4">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-14 max-w-4xl mx-auto text-center">
            <p className="text-[15px] text-[#666] leading-[1.85] font-light mb-4">
              We do not compromise on quality and strict quality checks are conducted frequently to maintain the much needed quality. You can order any quality and we deliver everything you need with utmost commitment and responsibility.
            </p>
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 border-t border-black/[0.08]">
            {stoneProductsData.sandstoneProducts
              .filter(item => item.title !== "Sagar Black Sandstone")
              .map((item, idx) => (
              <Link
                key={idx}
...
export default SagarBlackSandstoneView;
