// src/pages/DesertMintSandstoneView.jsx
...
const HERO_IMG = "/img/product/Stone Products/Desert Mint Sandstone/Desert-Mint-Sandstone.webp";
...
const patterns = [
  { name: "Pattern 1", stone: "Desert Mint", img: "/img/product/Stone Products/Desert Mint Sandstone/Patterns/Desert-Mint-Sandstone-03.webp", desc: "Yellow base with slight mint hues.", swatch: "#DCD0A4", type: "Honed", complexity: "Medium", bestFor: "Pool Surrounds" },
  { name: "Pattern 2", stone: "Desert Mint", img: "/img/product/Stone Products/Desert Mint Sandstone/Patterns/Desert-Mint-Sandstone-04 (1).webp", desc: "Classic and exotic charm for any space.", swatch: "#C6B98D", type: "Flamed", complexity: "High", bestFor: "Wall Cladding" },
  { name: "Pattern 3", stone: "Desert Mint", img: "/img/product/Stone Products/Desert Mint Sandstone/Patterns/Desert-mint-sandstone-04.webp", desc: "Stunning flamed finish with excellent durability.", swatch: "#D0C49E", type: "Calibrated", complexity: "Low", bestFor: "Pathways" },
  { name: "Pattern 4", stone: "Desert Mint", img: "/img/product/Stone Products/Desert Mint Sandstone/Patterns/Desert-mint-sandstone-05.webp", desc: "Elegant brushed texture for classic aesthetics.", swatch: "#B7A87A", type: "Brushed", complexity: "Medium", bestFor: "Garden Decoration" },
  { name: "Pattern 5", stone: "Desert Mint", img: "/img/product/Stone Products/Desert Mint Sandstone/Patterns/Desert-mint-sandstone-06.webp", desc: "Sandblasted for a natural and supreme setting.", swatch: "#DFD5B1", type: "Sandblasted", complexity: "High", bestFor: "Driveways" }
];

const MARBLE_TEXTURE = patterns[0].img;

const galleryImages = [
  "/img/product/Stone Products/Desert Mint Sandstone/Desert-Mint-Sandstone-02 (1).webp",
  "/img/product/Stone Products/Desert Mint Sandstone/Desert-mint-sandstone-01.webp",
  "/img/product/Stone Products/Desert Mint Sandstone/Desert-mint-sandstone-02.webp",
  "/img/product/Stone Products/Desert Mint Sandstone/Desert-mint-sandstone-03.webp",
  "/img/product/Stone Products/Desert Mint Sandstone/Patterns/Desert-Mint-Sandstone-03.webp",
  "/img/product/Stone Products/Desert Mint Sandstone/Patterns/Desert-Mint-Sandstone-04 (1).webp"
];

const steps = [
  { title: "Stone Selection", body: "Carefully selected sandstone with a yellow base and slight mint hues." },
  { title: "Precision Finishing", body: "Available in honed, flamed, calibrated, brushed, and sandblasted finishes." },
  { title: "Custom Sizing", body: "Depending on demands, we offer diverse sizes and thicknesses." },
  { title: "Final Embellishment", body: "Embellished with beautiful patterns, ready for traditional or stylish paving." },
];

const LENS_SIZE = 180;
const ZOOM = 2.4;

const DesertMintSandstoneView = () => {
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-6">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              Desert Mint is a beautiful sandstone with yellow base color and slight hints of mint hues. It can seamlessly compliment any decor with its sizzling and appealing shades. This sandstone brings classic and exotic charm to any place where interior or exterior. Beautiful designing, interior wall cladding, and pool surrounds are the common applications to Mint desert sandstones.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              We supply desert Mint sandstones India in stunning finishes like honed, flamed, calibrated, brushed, and sandblasted. They are made in different shapes and sizes. The stones can be plain or carved with different designs, it creates a natural focal point for a supreme setting. They are very appealing and eye-catching and made in a different range of designs and color combinations.
            </p>
            <div className="pt-4">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-14 max-w-4xl mx-auto text-center">
            <p className="text-[15px] text-[#666] leading-[1.85] font-light mb-4">
              Depending on the demands of our potential clients, we offer mint dessert sandstone in diverse sizes and thicknesses. They are easy to install and prevent rust. They are widely praised for their stunning appearance. Desert mint stone paving is highly used for garden decoration and pathways. You can choose among traditional and stylish paving for walking area and driveways.
            </p>
            
            <div className="flex flex-wrap justify-center gap-4">
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Made available in attractive designs</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Excellent quality material</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Economical price</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Supreme insulation</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> High durability</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Appealing look</span>
            </div>
          </div>
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 border-t border-black/[0.08]">
            {stoneProductsData.sandstoneProducts
              .filter(item => item.title !== "Desert Mint Sandstone")
              .map((item, idx) => (
              <Link
                key={idx}
...
export default DesertMintSandstoneView;
