...
const HERO_IMG = "/img/product/Stone Products/Gwalior Stone/Sandstone Palisade/image.png";
const TEXTURE_IMG = "/img/product/Stone Products/Gwalior Stone/Sandstone Palisade/image copy 8.png";
const CTA_IMG = "/img/product/Stone Products/Gwalior Stone/Sandstone Palisade/image copy 7.png";
...
const galleryImages = [
  "/img/product/Stone Products/Gwalior Stone/Sandstone Palisade/image copy.png",
  "/img/product/Stone Products/Gwalior Stone/Sandstone Palisade/image copy 2.png",
  "/img/product/Stone Products/Gwalior Stone/Sandstone Palisade/image copy 3.png",
  "/img/product/Stone Products/Gwalior Stone/Sandstone Palisade/image copy 4.png",
  "/img/product/Stone Products/Gwalior Stone/Sandstone Palisade/image copy 5.png",
  "/img/product/Stone Products/Gwalior Stone/Sandstone Palisade/image copy 6.png",
];

const featuresList = [
  { text: "Optimal strength" },
  { text: "Smooth texture" },
  { text: "Dimensional accuracy" },
  { text: "Better durability" },
  { text: "Natural make-up" },
  { text: "Customized dimensions" },
];

const steps = [
  { title: "Premium Mining", body: "Our products are mined from the top quality mines to ensure the best raw materials for every piece." },
  { title: "Advanced Processing", body: "We process the stones using highly advanced techniques to maintain supreme quality and dimensional accuracy." },
  { title: "Quality Checks", body: "We repeatedly conduct rigorous quality checks to ensure our products are 100% defect free." },
  { title: "Secure Packaging", body: "Our sophisticated packaging ensures clients receive the stones undamaged and perfectly on time." },
];

const LENS_SIZE = 180;
const ZOOM = 2.4;

const SandstonePalisadeView = () => {
      ...
      <section className="relative h-screen w-full overflow-hidden bg-[#111]">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6 max-w-5xl mx-auto">
          ...
          <p ref={heroSubRef} className="opacity-0 text-lg md:text-2xl text-white/80 font-light max-w-2xl mx-auto leading-relaxed mb-10">
            High-quality sandstone palisades mined from top-quality mines and processed using highly advanced techniques.
          </p>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-6">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              STONE INDIA is one of the best manufacturers and suppliers of high-quality sandstone palisades. Our products are available in customized dimensions and they are mined from the top quality mines. We have been processing the stones using highly advanced techniques to maintain supreme quality.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              Our sandstone palisade products are widely admired for their optimal strength, smooth texture, dimensional accuracy, better durability, and natural make-up. A large number of people are using our products for construction purpose in public gardens, pavements business premises, home exteriors, and many other places.
            </p>
            <div className="pt-4">
      ...
      <section id="patterns" className="reveal-block py-20 sm:py-28 px-6 bg-[#FAFAF8]">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-8">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              We do not confine our services to sourcing, manufacturing and shipping alone. In order to make our products 100% defect free, we repeatedly conduct quality checks and this practice plays an important role in winning the trust of our customers.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
          ...
          <div className="split-right relative aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl">
            <img src={galleryImages[2]} alt="Sandstone Palisade" className="w-full h-full object-cover" />
            ...
            <div className="absolute bottom-10 left-10 right-10 pointer-events-none">
              <h3 className="text-white font-serif text-3xl mb-3">Natural Excellence</h3>
              <p className="text-white/80 font-light text-sm">Customized dimensions for your unique requirements.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center reveal-block">
          <div className="split-left">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light mb-5">
              Hover over the stone to inspect the optimal strength, smooth texture, and natural make-up up close —
              the same quality you'll find in every palisade product.
            </p>
      ...
      <section id="contact" className="relative py-32 flex items-center justify-center overflow-hidden bg-[#111]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center flex flex-col items-center">
          ...
          <p className="text-lg md:text-xl text-white/70 font-light max-w-2xl mx-auto mb-10 leading-relaxed">
            Available in bulk for wholesale buyers globally — the perfect choice for public gardens, pavements business premises, home exteriors, and many other places.
          </p>
...
export default SandstonePalisadeView;
