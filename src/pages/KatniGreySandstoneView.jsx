// src/pages/KatniGreySandstoneView.jsx
...
const HERO_IMG = "/img/product/Stone Products/Katni Grey Sandstone/Katni-grey-sand-stone-1.webp";
...
const patterns = [
  { name: "Pattern 1", stone: "Katni Grey", img: "/img/product/Stone Products/Katni Grey Sandstone/Patterns/Katni-Grey-Sandstone-03-1.webp", desc: "Trendy design with fine finish.", swatch: "#7B7B7B", type: "Natural", complexity: "High", bestFor: "Landscaping" },
  { name: "Pattern 2", stone: "Katni Grey", img: "/img/product/Stone Products/Katni Grey Sandstone/Patterns/Katni-Grey-Sandstone-04.jpg", desc: "Solid modern feel and seamless appearance.", swatch: "#8F8F8F", type: "Split Surface", complexity: "Medium", bestFor: "Paving" },
  { name: "Pattern 3", stone: "Katni Grey", img: "/img/product/Stone Products/Katni Grey Sandstone/Patterns/Katni-grey-sand-stone-3.webp", desc: "Consistent color with proper even edging.", swatch: "#A1A1A1", type: "Natural", complexity: "Low", bestFor: "Wall Cladding" }
];

const MARBLE_TEXTURE = patterns[0].img;

const galleryImages = [
  "/img/product/Stone Products/Katni Grey Sandstone/Katni-Grey-Sandstone-02-1.webp",
  "/img/product/Stone Products/Katni Grey Sandstone/Katni-Grey-Sandstone-1.webp",
  "/img/product/Stone Products/Katni Grey Sandstone/Katni-grey-sand-stone-1.webp",
  "/img/product/Stone Products/Katni Grey Sandstone/Katni-grey-sand-stone-2.webp",
  "/img/product/Stone Products/Katni Grey Sandstone/Patterns/Katni-Grey-Sandstone-03-1.webp",
  "/img/product/Stone Products/Katni Grey Sandstone/Patterns/Katni-grey-sand-stone-3.webp"
];

const steps = [
  { title: "Stone Sourcing", body: "We source the highest quality Katni grey sandstones available in the market." },
  { title: "Precision Manufacturing", body: "Our skilled technicians work with clinical precision to offer the best stones." },
  { title: "Even Edging", body: "Stones are carefully cut to ensure proper even edging and seamless appearance." },
  { title: "Quality Verification", body: "We follow the best manufacturing practices to keep our customers truly satisfied." },
];

const LENS_SIZE = 180;
const ZOOM = 2.4;

const KatniGreySandstoneView = () => {
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-6">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              STONE INDIA, Katni grey sandstones are an excellent option if you are looking for the best quality stones available in the market. We focus hard to make our products truly distinct with amazing features. The most consistent color can always be associated with our products and they come with proper even edging as well.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              Generally speaking, they are hard-wearing sandstones. These stones have a solid modern feel and when laid out around a pool, they look surprisingly stunning. Along with the color consistency, they are highly durable and you can for wall cladding and other interior applications. Our products are available in two shades and they include dark gray and light gray.
            </p>
            <div className="pt-4">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-14 max-w-4xl mx-auto text-center">
            <p className="text-[15px] text-[#666] leading-[1.85] font-light mb-4">
              To keep our customers truly satisfied, we follow the best manufacturing practices and our skilled technicians work with clinical precision to offer the best stones available in the market. Our stones are immensely popular in the construction of landscaping and paving projects.
            </p>
            
            <div className="flex flex-wrap justify-center gap-4">
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Trendy design</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Fine finish</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Seamless appearance</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Landscaping projects</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Paving projects</span>
            </div>
          </div>
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 border-t border-black/[0.08]">
            {stoneProductsData.sandstoneProducts
              .filter(item => item.title !== "Katni Grey Sandstone")
              .map((item, idx) => (
              <Link
                key={idx}
...
export default KatniGreySandstoneView;
