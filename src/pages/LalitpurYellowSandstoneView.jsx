// src/pages/LalitpurYellowSandstoneView.jsx
...
const HERO_IMG = "/img/product/Stone Products/Lalitpur yellow sandstone/LalitPur-yellow-sand-stone.webp";
...
const patterns = [
  { name: "Pattern 1", stone: "Lalitpur Yellow", img: "/img/product/Stone Products/Lalitpur yellow sandstone/Patterns/LalitPur-yellow-sand-stone-05.jpg", desc: "Aesthetic value and sturdiness for perfect finish.", swatch: "#B89D6A", type: "Natural", complexity: "High", bestFor: "Exterior Paving" },
  { name: "Pattern 2", stone: "Lalitpur Yellow", img: "/img/product/Stone Products/Lalitpur yellow sandstone/Patterns/LalitPur-yellow-sand-stone-06.webp", desc: "Weather resistant and durable for outdoor use.", swatch: "#C5A878", type: "Split Surface", complexity: "Medium", bestFor: "Garden Pathways" },
  { name: "Pattern 3", stone: "Lalitpur Yellow", img: "/img/product/Stone Products/Lalitpur yellow sandstone/Patterns/LalitPur-yellow-sand-stone-07.webp", desc: "Low water absorption, ideal for wet areas.", swatch: "#A38550", type: "Natural", complexity: "Low", bestFor: "Bathroom Walls" },
  { name: "Pattern 4", stone: "Lalitpur Yellow", img: "/img/product/Stone Products/Lalitpur yellow sandstone/Patterns/Lalitpur-yellow-sandstone-03.webp", desc: "Saline water resistant with higher performance.", swatch: "#D0B384", type: "Polished", complexity: "High", bestFor: "Kitchen Counters" },
  { name: "Pattern 5", stone: "Lalitpur Yellow", img: "/img/product/Stone Products/Lalitpur yellow sandstone/Patterns/Lalitpur-yellow-sandstone-04.webp", desc: "Excellent mechanical strength for paving.", swatch: "#BD9E6B", type: "Shot Blasted", complexity: "Medium", bestFor: "Outdoor Pathways" }
];

const MARBLE_TEXTURE = patterns[0].img;

const galleryImages = [
  "/img/product/Stone Products/Lalitpur yellow sandstone/LalitPur-yellow-sand-stone-02.webp",
  "/img/product/Stone Products/Lalitpur yellow sandstone/LalitPur-yellow-sand-stone-03.jpg",
  "/img/product/Stone Products/Lalitpur yellow sandstone/LalitPur-yellow-sand-stone-04.webp",
  "/img/product/Stone Products/Lalitpur yellow sandstone/Lalitpur-yellow-sandstone.webp",
  "/img/product/Stone Products/Lalitpur yellow sandstone/Lalitpur-yellow-sandstone-02.webp",
  "/img/product/Stone Products/Lalitpur yellow sandstone/Patterns/LalitPur-yellow-sand-stone-05.jpg"
];

const steps = [
  { title: "Precision Cutting", body: "We make use of highly advanced and precision cutting machines during the manufacturing process." },
  { title: "Custom Thickness", body: "Available in various thicknesses and sizes to meet client requirements." },
  { title: "Quality Assurance", body: "Repeated quality checks are conducted to eliminate the possibility of even minute defects." },
  { title: "Stock Maintenance", body: "We maintain a large stock of Lalitpur yellow sandstones to fulfill orders of any quantity." },
];

const LENS_SIZE = 180;
const ZOOM = 2.4;

const LalitpurYellowSandstoneView = () => {
      ...
      <section className="relative h-[100svh] min-h-[500px] sm:min-h-[600px] w-full overflow-hidden bg-[#111]">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-end sm:justify-center text-center px-4 sm:px-6 pb-20 sm:pb-0 max-w-5xl mx-auto">
          ...
          <p ref={heroSubRef} className="opacity-0 text-sm sm:text-lg md:text-2xl text-white/80 font-light max-w-2xl mx-auto leading-relaxed mb-6 sm:mb-10">
            If you have been looking for the best quality Yellow Sandstone, you can trust Stone India.
          </p>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-6">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif text-[#111] leading-[1.2]">
              If you have been looking for the best quality <span className="text-[#B8955D] italic">Yellow Sandstone</span>, you can trust Stone India.
            </h2>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              STONE INDIA offers the finest Lalitpur Yellow Sandstone available in the market for our clients. We make use of highly advanced and precision cutting machines during the manufacturing process and these stones are available in various thicknesses and sizes. Our Yellow Sandstone is widely perceived as the most refined one and many people become eloquent when they talk about aesthetic value and sturdiness.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              We respect the requirements of our clients and offer them the best value for their money. Our products are extremely cost-effective and the quality can simply be described as excellent. Repeated quality checks are being conducted to eliminate the possibility of even minute defects and the most advanced technology and tools are employed to offer the perfect finish for all products.
            </p>
            <div className="pt-4">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-serif text-[#111] leading-[1.2]">
              Wide Range Of Patterns <span className="text-[#B8955D] italic">Of Yellow Sandstone</span>
            </h2>
          </div>
          
          <div className="mb-14 max-w-4xl mx-auto text-center">
            <p className="text-[15px] text-[#666] leading-[1.85] font-light mb-4">
              The positive feedback of our existing clients gives us immense satisfaction and we offer quality advice on how to maintain the stone effectively. You can order whatever quantity you want because we maintain a large stock of Lalitpur yellow sandstones.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Low water absorption</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Saline water resistant</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Excellent mechanical strength</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Higher Performance</span>
            </div>
          </div>
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 border-t border-black/[0.08]">
            {stoneProductsData.sandstoneProducts
              .filter(item => item.title !== "Lalitpur Yellow Sandstone")
              .map((item, idx) => (
              <Link
                key={idx}
...
export default LalitpurYellowSandstoneView;
