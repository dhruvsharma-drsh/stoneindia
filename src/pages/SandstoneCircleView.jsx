// src/pages/SandstoneCircleView.jsx
...
/* ── Asset pool ── */
const HERO_IMG = "/img/product/Stone Products/Gwalior Stone/Sandstone Circle/Patterns/Sandstone-Circle-04.webp"; // Sandstone Hero
const MARBLE_TEXTURE = "/img/finitures_texture.png";
const MOSAIC_TEASE = "/img/mosaics--products-tease.webp";

const galleryImages = [
  "/img/product/Stone Products/Gwalior Stone/Sandstone Circle/Patterns/Sandstone-Circle-04.webp",
  "/img/product/Stone Products/Gwalior Stone/Sandstone Circle/If you have been/Sandstone-Circle.webp"
];
...
const patterns = [
  { name: "Geometric Random", stone: "Sandstone", img: "/img/product/Stone Products/Gwalior Stone/Sandstone Circle/Patterns/Sandstone-Circle-04.webp", desc: "Organic and inviting random cuts ideal for creating sizzling visual appearances.", swatch: "#C2CBBA", type: "Organic", complexity: "Medium", bestFor: "Landscaping" },
  { name: "Classic Hexagonal", stone: "Sandstone", img: "/img/product/Stone Products/Gwalior Stone/Sandstone Circle/Patterns/Sandstone-Circle.webp", desc: "A classic pattern providing a neutral and sophisticated paving aesthetic.", swatch: "#D0BA8E", type: "Classic", complexity: "Low", bestFor: "Pavements" },
];

const features = [
  { title: "Lightweight", body: "Easy to transport and handle without compromising on structural integrity or strength." },
  { title: "Beautiful Shine", body: "Provides an elegant, natural luster that enhances any outdoor or indoor space." },
  { title: "Durable Structure", body: "Built to last with supreme resistance to UV, weather impacts, and abrasion." },
  { title: "Vibrant Landscaping", body: "Transforms ordinary gardens and pavements into striking, sizzling landscapes." },
  { title: "Uniform Texture", body: "Emphasizes the uniformity of color from stone to stone for a seamless aesthetic." }
];

const LENS_SIZE = 180;
const ZOOM = 2.4;

const SandstoneCircleView = () => {
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-6">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              Serving the diverse construction project requirements, We offer the Sandstone circle in India in different types of Green sandstone circles, grey circle, Kandla Grey, Mint, Modak, yellow, and more. The circles are made of different sizes, patterns, and colors with a seamless finish.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              Sandstone circles have major applications in public gardens, pavements, and temples. They are made in exclusive patterns with supreme features of high strength and smooth surface. Sandstone circles look stunning in a paving area and when laid on their own in a garden, they create a sizzling appearance.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
          ...
          <div className="split-right relative aspect-square lg:aspect-[4/5] rounded-3xl overflow-hidden bg-[#FAFAF8] border border-[#EDEDE9] shadow-[0_20px_60px_rgba(0,0,0,0.08)] flex flex-col justify-center gap-4 sm:gap-5 py-6">
            ...
            <div className="flex gap-4 sm:gap-5 w-max animate-marquee" style={{ animationDuration: '40s' }}>
              {[
                "/img/product/Stone Products/Gwalior Stone/Sandstone Circle/If you have been/Sandstone-Circle.webp",
                "/img/product/Stone Products/Gwalior Stone/Sandstone Circle/If you have been/Sandstone-Circle-02.webp",
                "/img/product/Stone Products/Gwalior Stone/Sandstone Circle/Patterns/Sandstone-Circle-04.webp",
                "/img/product/Stone Products/Gwalior Stone/Sandstone Circle/Patterns/Sandstone-Circle.webp",
                "/img/product/Stone Products/Gwalior Stone/Sandstone Circle/If you have been/Sandstone-Circle.webp",
                "/img/product/Stone Products/Gwalior Stone/Sandstone Circle/If you have been/Sandstone-Circle-02.webp"
              ].map((img, idx) => (
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center reveal-block">
          <div className="split-left">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light mb-5">
              Hover over the stone to inspect the uniform texture, natural shine, and color blends up close —
              the same detail you'll find in every piece.
            </p>
            ...
            <div className="lg:col-span-8">
              <div className="relative aspect-[16/10] rounded-3xl overflow-hidden shadow-2xl mb-6 bg-black">
                ...
                <div className="absolute bottom-6 left-6 right-6 pointer-events-none">
                  <span className="text-white font-serif text-2xl lg:text-3xl block mb-2">{patterns[activePattern].name} Sandstone Circle</span>
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 border-t border-black/[0.08]">
            {stoneProductsData.grid
              .filter(item => item.title !== "Sandstone Circle" && item.title !== "Sandstone")
              .slice(0, 8)
              .map((item, idx) => (
              <Link
                key={idx}
      ...
      <section id="contact" className="relative py-32 flex items-center justify-center overflow-hidden bg-[#111]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center flex flex-col items-center">
          ...
          <h2 className="text-2xl sm:text-4xl md:text-6xl font-serif text-white mb-6 sm:mb-8">
            Elevate Your <span className="italic font-light">Landscaping</span>
          </h2>
          <p className="text-lg md:text-xl text-white/70 font-light max-w-2xl mx-auto mb-10 leading-relaxed">
            ...
            gardens, temples, and elegant pavements.
          </p>
...
export default SandstoneCircleView;
