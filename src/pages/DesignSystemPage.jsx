        ...
        <section>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-[2rem] p-10 border border-gray-200 shadow-xl relative overflow-hidden group">
              ...
              <div className="flex items-center gap-4">
                <button className="px-6 py-3 rounded-full bg-[#111111] text-white text-sm font-bold hover:bg-[#B8955D] transition-colors shadow-lg shadow-black/10">
                  Secondary Action
                </button>
              </div>
            </div>
                  ...
                  <div className="p-8 md:p-12 flex flex-col gap-10" style={{ fontFamily: `"${selectedFont.name}", sans-serif` }}>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-4">
                        ...
                        <button className="px-8 py-3.5 rounded-full bg-[#111] text-white text-sm font-bold hover:bg-[#B8955D] transition-colors">
                          Contact Us
                        </button>
                        <button className="px-8 py-3.5 rounded-full border-2 border-[#B8955D] text-[#B8955D] text-sm font-bold hover:bg-[#B8955D] hover:text-white transition-all">
                          View Projects
                        </button>
