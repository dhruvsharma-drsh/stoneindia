// src/pages/ShivpuriSandstoneView.jsx
...
const HERO_IMG = "/img/product/Stone Products/Shivpuri Sandstone/shivpuri-sand-stone-1.jpg";
...
const patterns = [
  { name: "Pattern 1", stone: "Shivpuri", img: "/img/product/Stone Products/Shivpuri Sandstone/Patterns/shivpuri-sand-stone-4.webp", desc: "Mixed color with beautiful texture.", swatch: "#C6A284", type: "Natural", complexity: "Medium", bestFor: "Paving Material" },
  { name: "Pattern 2", stone: "Shivpuri", img: "/img/product/Stone Products/Shivpuri Sandstone/Patterns/shivpuri-sand-stone-5.webp", desc: "Sleek and contemporary appearance.", swatch: "#D1A987", type: "Polished", complexity: "High", bestFor: "Carving & Architecture" }
];

const MARBLE_TEXTURE = patterns[0].img;

const galleryImages = [
  "/img/product/Stone Products/Shivpuri Sandstone/shivpuri-sand-stone-2.webp",
  "/img/product/Stone Products/Shivpuri Sandstone/shivpuri-sand-stone-3.webp",
  "/img/product/Stone Products/Shivpuri Sandstone/Patterns/shivpuri-sand-stone-4.webp",
  "/img/product/Stone Products/Shivpuri Sandstone/Patterns/shivpuri-sand-stone-5.webp",
  "/img/product/Stone Products/Shivpuri Sandstone/shivpuri-sand-stone-2.webp",
  "/img/product/Stone Products/Shivpuri Sandstone/shivpuri-sand-stone-3.webp"
];

const steps = [
  { title: "Mining", body: "We maintain state-of-the-art machines and equipment at the mining sites in Madhya Pradesh." },
  { title: "Processing", body: "The stones are processed with beautiful surface finishes providing a natural to exotic look." },
  { title: "Quality Check", body: "Our unique and high-quality sandstones are approved by the government of India." },
  { title: "Application", widely: "Designed in a variety of shapes, sizes, and hues suitable for diverse applications." },
];

const LENS_SIZE = 180;
const ZOOM = 2.4;

const ShivpuriSandstoneView = () => {
      ...
      <section className="reveal-block py-20 sm:py-28 px-6 bg-white">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-6">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              Shivpuri Sandstones made in Gwalior are an outstanding building stone for use in interior and exterior applications. They are widely used for carving and architectural applications for example pillars, arches, garden furniture, landscaping, and stone arts. We offer Shivpuri sandstones at wholesale price to style your house and garden. The unique and quality sandstones are approved by the government of India.
            </p>
            <div className="pt-4">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-14 max-w-4xl mx-auto text-center">
            <p className="text-[15px] text-[#666] leading-[1.85] font-light mb-4">
              These sandstones are mainly found in Madhya Pradesh and are extensively exported. They are popularly used in residential houses, commercial buildings, and hotels. The stones are processed with beautiful surface finishes providing natural to exotic look. Looking for a timeless style, Shivpuri Sandstones attract architects for their sleek and contemporary appearance. Additionally, wherever they are placed, the stones protect your place from the harsh climates such as heavy rain, blistering heat, and snow.
            </p>
            
            <div className="flex flex-wrap justify-center gap-4">
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Resistant to weather</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Easy to work with</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Ideal for use as building and paving material</span>
            </div>
          </div>
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 border-t border-black/[0.08]">
            {stoneProductsData.sandstoneProducts
              .filter(item => item.title !== "Shivpuri Sandstone")
              .map((item, idx) => (
              <Link
                key={idx}
...
export default ShivpuriSandstoneView;
