// src/pages/GwaliorSandstoneView.jsx
...
const HERO_IMG = "/img/product/Stone Products/Gwalior Sandstone/Sandstone03.webp";
...
const patterns = [
  { name: "Classic Sandstone", stone: "Gwalior Sandstone", img: "/img/product/Stone Products/Gwalior Sandstone/Patterns/Sandstone.webp", desc: "A sedimentary rock consisting of rock grains or minerals.", swatch: "#A9C4A0", type: "Directional", complexity: "High", bestFor: "Feature Walls" },
  { name: "Weather Resistant", stone: "Gwalior Sandstone", img: "/img/product/Stone Products/Gwalior Sandstone/Patterns/Sandstone02.webp", desc: "Porosity of this Gwalior Sandstone is very low, and it is resistant to any weather.", swatch: "#4A6D7C", type: "Interlocking", complexity: "Medium", bestFor: "Flooring" },
  { name: "Premium Quality", stone: "Gwalior Sandstone", img: "/img/product/Stone Products/Gwalior Sandstone/Sandstone03.webp", desc: "Premium quality products at the most reasonable rates.", swatch: "#C9A66B", type: "Parallel", complexity: "Low", bestFor: "Facades" }
];

const MARBLE_TEXTURE = patterns[0].img;

const galleryImages = [
  "/img/product/Stone Products/Gwalior Sandstone/Patterns/Sandstone.webp",
  "/img/product/Stone Products/Gwalior Sandstone/Patterns/Sandstone02.webp",
  "/img/product/Stone Products/Gwalior Sandstone/Sandstone03.webp",
  "/img/product/Stone Products/Gwalior Sandstone/Patterns/Sandstone.webp",
  "/img/product/Stone Products/Gwalior Sandstone/Patterns/Sandstone02.webp",
  "/img/product/Stone Products/Gwalior Sandstone/Sandstone03.webp"
];
...
const steps = [
  ...
  { title: "Customised Production", body: "Based on the requirements of the clients, we also offer customised production." },
      ...
      <section className="relative h-[100svh] min-h-[500px] sm:min-h-[600px] w-full overflow-hidden bg-[#111]">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-end sm:justify-center text-center px-4 sm:px-6 pb-20 sm:pb-0 max-w-5xl mx-auto">
          ...
          <p ref={heroSubRef} className="opacity-0 text-sm sm:text-lg md:text-2xl text-white/80 font-light max-w-2xl mx-auto leading-relaxed mb-6 sm:mb-10">
            If you have been looking for the best quality Gwalior Sandstone, you can trust Stone India.
          </p>
          ...
          <div ref={heroCtaRef} className="opacity-0 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 w-full sm:w-auto">
            <a href="#contact" className="px-6 sm:px-8 py-3 sm:py-4 rounded-full bg-gradient-to-r from-[#B8955D] to-[#DFBA73] text-black font-bold text-xs sm:text-sm tracking-wider uppercase hover:scale-105 hover:shadow-[0_0_40px_rgba(184,149,93,0.5)] transition-all duration-300 flex items-center gap-2">
              <PhoneCall size={16} className="sm:w-[18px] sm:h-[18px]" /> Request Wholesale Quote
            </a>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-6">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif text-[#111] leading-[1.2]">
              If you have been looking for the best quality <span className="text-[#B8955D] italic">Gwalior Sandstone</span>, you can trust Stone India.
            </h2>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              Among the most precious gifts that nature offers, rocks and minerals stand tall. Gwalior Sandstone is a sedimentary rock consisting of rock grains or minerals. They are available in a variety of colors, including white, red, yellow, tan, gray, and brown, as well.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              There might be minor color tonal variations, but this might be in the tolerance limit. The hardness is around 6.5 to 7 on Moh’s scale, and the density ranges from 2.3 to 2.4 kg/cm3. Moreover, the porosity of this Gwalior Sandstone is very low, and it is resistant to any weather. Talking about the chemical composition, these are resistant mono-mineralic rocks that have silica as the main constituent. Other constituents include Alumina, Lime, Soda, Iron, SiO2, Loss On Ignition, and Magnesia.
            </p>
            <div className="pt-4">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-serif text-[#111] leading-[1.2]">
              We Offer A Wide Range Of <span className="text-[#B8955D] italic">Gwalior sandstone Patterns</span>
            </h2>
          </div>
          
          <div className="mb-14 max-w-4xl mx-auto text-center">
            <p className="text-[15px] text-[#666] leading-[1.85] font-light mb-4">
              Stone India, the leading Gwalior Sandstone Manufacturers in India offers weather-resistant, high-quality sandstones for your building and paving requirements. Our products, when installed as building stones, offer an amazing look, and their quality and color can be described as unbeatable. Our amazing collection of products includes sandstone slabs, tiles, cobbles, pebbles, blocks, strips, bricks, and many more.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              Based on the requirements of the clients, we also offer customised production, and you get premium quality products at the most reasonable rates. We have been acquiring the best stones to meet our client’s high standards since we are the top-rated Gwalior Sandstone Suppliers in India. As a result of our unwavering dedication to quality, all of our current clients have become repeat clients.
            </p>
          </div>
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 border-t border-black/[0.08]">
            {stoneProductsData.sandstoneProducts
              .filter(item => item.title !== "Gwalior Sandstone")
              .map((item, idx) => (
              <Link
                key={idx}
              ...
              >
                ...
                <div className="hidden sm:flex items-center gap-3 opacity-60 group-hover:opacity-100 transition-opacity duration-500">
                  ...
                  <p className="text-[8px] md:text-[9px] text-[#555] uppercase tracking-[0.3em] font-medium line-clamp-2">
                    {item.desc}
                  </p>
                  <div className="w-4 h-[1px] bg-[#B4956C]/50" />
                </div>
...
export default GwaliorSandstoneView;
