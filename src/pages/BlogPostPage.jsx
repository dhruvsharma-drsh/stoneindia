    ...
    return (
      ...
      >
        ...
        <button
          ...
          className="px-6 py-3 rounded-full bg-[#14140F] text-white font-medium text-sm hover:bg-[#B7945D] transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#B8955D]"
        >
          Back to the journal
        </button>
      </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="w-10 h-10 rounded-full border border-[#E4E0D8] flex items-center justify-center text-[#14140F] hover:bg-[#B7945D] hover:text-[#111] hover:border-[#B8955D] transition-all focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#B8955D]"
              >
                <Link2 size={16} />
              </button>
              {copied && (
      ...
      {nextPost && (
        ...
        >
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-6 py-20 md:py-28 flex flex-col md:flex-row items-center justify-between gap-10">
            ...
            <div className="flex items-center gap-3 px-7 py-4 rounded-full bg-[#B7945D] text-black font-semibold text-sm shrink-0 group-hover:scale-105 group-hover:shadow-[0_0_30px_rgba(245,214,62,0.4)] transition-all">
              Continue reading
