// src/pages/ModakSandstoneView.jsx
...
const HERO_IMG = "/img/product/Stone Products/Modak Sandstone/Modak-Sandstone.jpg";
...
const patterns = [
  { name: "Pattern 1", stone: "Modak", img: "/img/product/Stone Products/Modak Sandstone/Patterns/Modak-Sandstone-03.webp", desc: "Satin pink fusion, perfect for cold climates.", swatch: "#C69680", type: "Natural", complexity: "High", bestFor: "Patio & Driveway" },
  { name: "Pattern 2", stone: "Modak", img: "/img/product/Stone Products/Modak Sandstone/Patterns/Modak-Sandstone-04.webp", desc: "Naturally riven paving surface for a premium finish.", swatch: "#BA8C75", type: "Split Surface", complexity: "Medium", bestFor: "Bathroom & Kitchen" }
];

const MARBLE_TEXTURE = patterns[0].img;

const galleryImages = [
  "/img/product/Stone Products/Modak Sandstone/Modak-Sandstone (1).jpg",
  "/img/product/Stone Products/Modak Sandstone/Modak-Sandstone.jpg",
  "/img/product/Stone Products/Modak Sandstone/Patterns/Modak-Sandstone-03.webp",
  "/img/product/Stone Products/Modak Sandstone/Patterns/Modak-Sandstone-04.webp",
  "/img/product/Stone Products/Modak Sandstone/Modak-Sandstone (1).jpg",
  "/img/product/Stone Products/Modak Sandstone/Modak-Sandstone.jpg"
];

const steps = [
  { title: "In-House Quarrying", body: "We conduct hand-cutting operations in-house at the Modak quarries for precision." },
  { title: "Slab Splitting", body: "Rough blocks are split into slabs of desired thickness to make pavers and flagstones." },
  { title: "Quality Control", body: "We take care of all aspects of quality control to ensure a premium finish." },
  { title: "Surface Weathering", body: "Aging methods are utilized to artificially weather the stone for a beautiful addition." },
];

const LENS_SIZE = 180;
const ZOOM = 2.4;

const ModakSandstoneView = () => {
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-6">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              Modak sandstones introduce a fusion of colors such as satin pink. With their uniqueness, hardness they are suitable for cold climates. We conduct hand-cutting operations in-house at the modak quarries. Rough blocks of modak are brought that are split into slabs of a desired thickness to make pavers and flagstones for additional size specifications.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              We are a leading Modak sandstone manufacturer offering well-chosen natural stone that brings a garden or room to life, creating a premium finish. Our skilled team works tirelessly to bring you an appealing collection.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              We provide complete peace of mind by taking care of aspects of quality control, fast and friendly communications. We are well known Modak sandstone suppliers in India providing a beautiful addition to your place leaving a naturally riven paving surface and aging methods to artificially weather the stone.
            </p>
            <div className="pt-4">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-14 max-w-4xl mx-auto text-center">
            <p className="text-[15px] text-[#666] leading-[1.85] font-light mb-4">
              Stone India sources and delivers the widest range of high-quality Modak stones for your project. We offer unbeatable choice, incomparable quality, and unbeatable prices so you can buy with confidence. We are able to lower material costs and hence supply you with high-quality materials at very economical prices. We have spent several years sourcing trustable quality Modak stones to offer solutions for architectural, sculptures and landscaping projects. Hence for any project large or small, Modak stones bring the wow factor.
            </p>
            
            <div className="flex flex-wrap justify-center gap-4">
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Patio & Path</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Driveway & Swimming Pool</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Kitchen & Bathroom</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Hallway & Conservatory</span>
            </div>
          </div>
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 border-t border-black/[0.08]">
            {stoneProductsData.sandstoneProducts
              .filter(item => item.title !== "Modak Sandstone")
              .map((item, idx) => (
              <Link
                key={idx}
...
export default ModakSandstoneView;
