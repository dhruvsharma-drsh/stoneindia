// src/pages/SteppingStoneTilesView.jsx
...
/* ── Asset pool ── */
const HERO_IMG = "/img/product/Stone Products/Gwalior Stone/Fossil Mint Natural stone/pattern 2.webp"; 
const MARBLE_TEXTURE = "/img/finitures_texture.png";
const MOSAIC_TEASE = "/img/mosaics--products-tease.webp";

// Using only the specific images for Stepping Stone Tiles
const galleryImages = [
  "/img/product/Stone Products/Gwalior Stone/Fossil Mint Natural stone/pattern 2.webp",
  "/img/product/Stone Products/Gwalior Stone/Stepping Stone Tiles/stepping-stone-tiles-02.webp"
];
...
const patterns = [
  { name: "Natural Walkway", stone: "Stepping Stones", img: "/img/product/Stone Products/Gwalior Stone/Stepping Stone Tiles/pattern1.webp", desc: "A naturally styled pattern that integrates seamlessly into garden pathways.", swatch: "#B6B2AB", type: "Natural", complexity: "Low", bestFor: "Gardens" },
  { name: "Organic Path", stone: "Stepping Stones", img: "/img/product/Stone Products/Gwalior Stone/Stepping Stone Tiles/pattern 2.webp", desc: "Organic cuts that offer an elegant, refined look suitable for villas and homes.", swatch: "#C0BCB4", type: "Organic", complexity: "Medium", bestFor: "Villas" },
];

const features = [
  { title: "Supremely Elegant", body: "Designed to look truly elegant with a highly refined finish for any setting." },
  { title: "Easy to Clean", body: "Extremely easy to maintain with an attractive surface finish that resists dirt." },
  { title: "Outstanding Durability", body: "Built to surpass all your durability expectations for long-term use." },
  { title: "World-Class Quality", body: "Continuous quality inspections ensure supreme quality for homes, villas, offices, and hotels." },
  { title: "Ready Stock", body: "Our large stock helps us meet all newly emerging requirements without unwanted delays." }
];

const LENS_SIZE = 180;
const ZOOM = 2.4;

const SteppingStoneTilesView = () => {
    ...
    <div ref={pageRef} className="bg-[#FAFAF8] min-h-[100svh] font-sans text-[#111]">
      ...
      <section className="relative h-[80vh] md:h-[90vh] w-full overflow-hidden bg-[#111]">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-end sm:justify-center text-center px-4 sm:px-6 pb-20 sm:pb-0 max-w-5xl mx-auto pt-20">
          ...
          <p ref={heroSubRef} className="opacity-0 text-sm sm:text-lg md:text-2xl text-white/80 font-light max-w-2xl mx-auto leading-relaxed mb-6 sm:mb-10">
            Enhance the looks of your interiors and exteriors with our wide assortment of elegant stepping stone tiles.
          </p>
      ...
      <div className="bg-white border-b border-[#EDEDE9] py-4 sticky top-0 z-40 backdrop-blur-xl bg-white/90">
        <div className="max-w-7xl mx-auto px-6 flex items-center gap-2 text-xs font-mono uppercase tracking-widest text-[#888]">
          ...
          <ChevronRight size={12} />
          <span className="text-[#B8955D] font-bold">Stepping Stone Tiles</span>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-6">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              If you want to enhance the looks of your interiors, you can purchase our stepping stone tiles. As one of the most celebrated manufacturers and suppliers of stepping stone tiles, STONE INDIA offers a wide assortment of stone tiles that meet your expectations with utmost efficiency.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              Our tiles have been designed in such a manner that they look truly elegant and a refined look can also be associated with them.
            </p>
          ...
          <div className="split-right relative aspect-square lg:aspect-[4/5] rounded-3xl overflow-hidden bg-[#FAFAF8] border border-[#EDEDE9] shadow-[0_20px_60px_rgba(0,0,0,0.08)] flex flex-col justify-center gap-4 sm:gap-5 py-6">
            ...
            <div className="flex gap-4 sm:gap-5 w-max animate-marquee" style={{ animationDuration: '40s' }}>
              {[
                "/img/product/Stone Products/Gwalior Stone/Stepping Stone Tiles/stepping-stone-tiles-03.jpg",
                "/img/product/Stone Products/Gwalior Stone/Stepping Stone Tiles/pattern1.webp",
                "/img/product/Stone Products/Gwalior Stone/Stepping Stone Tiles/stepping-stone-tiles-02.webp",
                "/img/product/Stone Products/Gwalior Stone/Stepping Stone Tiles/pattern 2.webp",
                "/img/product/Stone Products/Gwalior Stone/Stepping Stone Tiles/stepping-stone-tiles-03.jpg",
                "/img/product/Stone Products/Gwalior Stone/Stepping Stone Tiles/pattern1.webp"
              ].map((img, idx) => (
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center reveal-block">
          <div className="split-left">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light mb-5">
              Hover over the stone to inspect the refined look and elegant finish up close —
              the same durability and quality you'll find in every tile we supply.
            </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light max-w-3xl mx-auto">
              The demand for our products has exceeded all our expectations and our large stock helps us meet all the newly emerging requirements without any unwanted delay. Our stepping stone tiles are extremely easy to clean and the surface finish of these tiles has always been great source of attraction. When it comes to durability, they are going to surpass all your expectations.
            </p>
          </div>
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 border-t border-black/[0.08]">
            {stoneProductsData.grid
              .filter(item => item.title !== "Stepping Stone Tiles" && item.title !== "Stepping Stones")
              .slice(0, 8)
              .map((item, idx) => (
              <Link
                key={idx}
      ...
      <section id="contact" className="relative py-32 flex items-center justify-center overflow-hidden bg-[#111]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center flex flex-col items-center">
          ...
          <h2 className="text-2xl sm:text-4xl md:text-6xl font-serif text-white mb-6 sm:mb-8">
            Elevate Your <span className="italic font-light">Spaces</span>
          </h2>
          <p className="text-lg md:text-xl text-white/70 font-light max-w-2xl mx-auto mb-10 leading-relaxed">
            Our world-class manufacturing practices ensure you get the supreme quality you deserve. Contact us for bulk orders for homes, villas, offices, and hotels.
          </p>
...
export default SteppingStoneTilesView;
