...
const HERO_IMG = "/img/product/Stone Products/Gwalior Stone/Gwalior Mint Sandstone Slabs/image.png";
const TEXTURE_IMG = "/img/product/Stone Products/Gwalior Stone/Gwalior Mint Sandstone Slabs/image copy 5.png";
const CTA_IMG = "/img/product/Stone Products/Gwalior Stone/Gwalior Mint Sandstone Slabs/image copy 6.png";
...
const galleryImages = [
  "/img/product/Stone Products/Gwalior Stone/Gwalior Mint Sandstone Slabs/image copy.png",
  "/img/product/Stone Products/Gwalior Stone/Gwalior Mint Sandstone Slabs/image copy 2.png",
  "/img/product/Stone Products/Gwalior Stone/Gwalior Mint Sandstone Slabs/image copy 3.png",
  "/img/product/Stone Products/Gwalior Stone/Gwalior Mint Sandstone Slabs/image copy 4.png",
  "/img/product/Stone Products/Gwalior Stone/Gwalior Mint Sandstone Slabs/image copy 5.png",
  "/img/product/Stone Products/Gwalior Stone/Gwalior Mint Sandstone Slabs/image copy 6.png",
];

const featuresList = [
  { text: "Smooth finish" },
  { text: "Beautiful texture" },
  { text: "Longer life" },
  { text: "Weather and rust proof" },
  { text: "Customized solutions" },
  { text: "Advanced designs" },
];

const applicationsList = [
  { text: "Garden accessories" },
  { text: "Paving" },
  { text: "Handicrafts" },
  { text: "Garden equipment" },
  { text: "Outer construction or decor" },
  { text: "Hotels, restaurants, and houses" },
];

const steps = [
  { title: "Quarrying & Hand Cutting", body: "We have our own hand cutting operations at mint quarries to ensure the highest raw quality." },
  { title: "Advanced Manufacturing", body: "We use the best machinery and continuous research to manufacture premium sandstone slabs." },
  { title: "Surface Finishing", body: "Offered in natural, honed, sandblasted, antique, sawn polish, and mirror polish finishes." },
  { title: "Quality Assurance", body: "Enhancing the quality of products with rigorous testing for high tensile and compressive strength." },
];

const LENS_SIZE = 180;
const ZOOM = 2.4;

const GwaliorMintSandstoneSlabsView = () => {
      ...
      <section className="relative h-[100svh] min-h-[500px] sm:min-h-[600px] w-full overflow-hidden bg-[#111]">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-end sm:justify-center text-center px-4 sm:px-6 pb-20 sm:pb-0 max-w-5xl mx-auto">
          <div ref={heroBadgeRef} className="opacity-0 inline-flex items-center gap-2 px-5 py-2 rounded-full border border-white/20 bg-white/5 backdrop-blur-md mb-8">
            ...
            <span className="text-xs tracking-[0.2em] text-[#DFBA73] font-bold uppercase">Exotic Natural Stone</span>
          </div>
          ...
          <p ref={heroSubRef} className="opacity-0 text-sm sm:text-lg md:text-2xl text-white/80 font-light max-w-2xl mx-auto leading-relaxed mb-6 sm:mb-10">
            Wonderfully exotic sandstone in light cream, textured with beautiful natural patterns.
          </p>
      ...
      <section id="patterns" className="reveal-block py-20 sm:py-28 px-6 bg-[#FAFAF8]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          ...
          <div className="split-right relative aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl">
            <img src={galleryImages[1]} alt="Gwalior Mint Sandstone Slabs" className="w-full h-full object-cover" onLoad={(e) => {
            ...
            <div className="absolute bottom-10 left-10 right-10 pointer-events-none">
              <h3 className="text-white font-serif text-3xl mb-3">Versatile Elegance</h3>
              <p className="text-white/80 font-light text-sm">Light cream base textured with beautiful patterns, tailored to your custom requirements.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center reveal-block">
          <div className="split-left">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light mb-5">
              Hover over the stone to inspect the exotic light cream base, beautiful texture, and natural patterns up close —
              the same quality you'll find in every Gwalior Mint Slab.
            </p>
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 border-t border-black/[0.08]">
            {stoneProductsData.grid
              .filter(item => item.title !== "Gwalior Mint Sandstone Slabs")
              .slice(0, 8)
              .map((item, idx) => (
              <Link
                key={idx}
...
export default GwaliorMintSandstoneSlabsView;
