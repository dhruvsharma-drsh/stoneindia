...
const HERO_IMG = "/img/product/Stone Products/Gwalior Stone/Mosaic-Stone-Tiles-21.jpg";
const MOSAIC_1 = "/img/product/Stone Products/Gwalior Stone/Mosaic-Stone-Tiles1.webp";
const MOSAIC_2 = "/img/product/Stone Products/Gwalior Stone/Mosaic-Stone-Tiles-22.webp";
const MOSAIC_TEASE = "/img/textures/mosaics-products-tease.webp";
const MARBLE_TEXTURE = "/img/textures/marble-texture.png";
const GWALIOR_MINT = "/img/stones/gwalior-mint.png";
const KOTA_BLUE = "/img/stones/kota-blue.png";
const SAGAR_BLACK = "/img/stones/sagar-black.png";
const TEAKWOOD = "/img/stones/teakwood-sandstone.png";
const FINITURES = "/img/textures/finitures-texture.png";
...
const patterns = [
  { name: "Classic Herringbone", stone: "Gwalior Mint", img: "/img/product/Stone Products/Gwalior Stone/Mosaic Stone Tiles/Patterns/Mosaic-Stone-Tiles-21.jpg", desc: "Interlocking chevron cuts for a refined, directional texture.", swatch: "#A9C4A0", type: "Directional", complexity: "High", bestFor: "Feature Walls" },
  { name: "Basketweave", stone: "Kota Blue", img: "/img/product/Stone Products/Gwalior Stone/Mosaic Stone Tiles/Patterns/Mosaic-Stone-Tiles-22.webp", desc: "Alternating rectangular pairs that create depth and quiet movement.", swatch: "#4A6D7C", type: "Interlocking", complexity: "Medium", bestFor: "Flooring" },
  { name: "Linear Strip", stone: "Marble Vein", img: "/img/product/Stone Products/Gwalior Stone/Mosaic Stone Tiles/Patterns/mosaic-stone-tile-10.webp", desc: "Clean parallel bands, ideal for contemporary feature walls.", swatch: "#C9A66B", type: "Parallel", complexity: "Low", bestFor: "Facades" },
  { name: "Tumbled Pebble", stone: "Sandstone Blend", img: "/img/product/Stone Products/Gwalior Stone/Mosaic Stone Tiles/Patterns/mosaic-stone-tile-6.webp", desc: "Organic, tumbled edges for a natural, softened finish underfoot.", swatch: "#8B8D8A", type: "Organic", complexity: "High", bestFor: "Wet Areas" },
  { name: "Geometric Block", stone: "Teakwood", img: "/img/product/Stone Products/Gwalior Stone/Mosaic Stone Tiles/Patterns/mosaic-stone-tile-7.jpg", desc: "Bold, modern geometric cuts that make a strong architectural statement.", swatch: "#D9A441", type: "Structured", complexity: "Medium", bestFor: "Pathways" },
];

const galleryImages = [
  "/img/product/Stone Products/Gwalior Stone/Mosaic Stone Tiles/If you have been/Mosaic-Stone-Tiles-23.webp",
  "/img/product/Stone Products/Gwalior Stone/Mosaic Stone Tiles/If you have been/Mosaic-Stone-Tiles-24.webp",
  "/img/product/Stone Products/Gwalior Stone/Mosaic Stone Tiles/If you have been/mosaic-stone-tile-1.webp",
  "/img/product/Stone Products/Gwalior Stone/Mosaic Stone Tiles/If you have been/mosaic-stone-tile-2.webp",
  "/img/product/Stone Products/Gwalior Stone/Mosaic Stone Tiles/If you have been/mosaic-stone-tile-3.jpg",
  "/img/product/Stone Products/Gwalior Stone/Mosaic Stone Tiles/If you have been/mosaic-stone-tile-4.webp",
  "/img/product/Stone Products/Gwalior Stone/Mosaic Stone Tiles/If you have been/mosaic-stone-tile-5.webp",
];
      ...
      <section className="relative h-[100svh] min-h-[500px] sm:min-h-[600px] w-full overflow-hidden bg-[#111]">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-end sm:justify-center text-center px-4 sm:px-6 pb-20 sm:pb-0 max-w-5xl mx-auto">
          ...
          <p ref={heroSubRef} className="opacity-0 text-sm sm:text-lg md:text-2xl text-white/80 font-light max-w-2xl mx-auto leading-relaxed mb-6 sm:mb-10">
            Every tile hand-set. Every pattern, a piece of the quarry brought to life.
          </p>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-6">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              STONE INDIA has been successfully meeting the demands of mosaic stone tiles that are extensively being used in the field of construction. Our mosaic tiles come with a flawless finish and they can be described as trendy and stylish as well.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 border-t border-black/[0.08]">
            {stoneProductsData.grid
              .filter(item => item.title !== "Mosaic Stone Tiles")
              .slice(0, 8)
              .map((item, idx) => (
              <Link
                key={idx}
...
export default MosaicStoneTilesView;
