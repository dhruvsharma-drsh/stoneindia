// src/pages/KatniYellowSandstoneView.jsx
...
const HERO_IMG = "/img/product/Stone Products/Katni Yellow Sandstone/Lalitpur-yellow-sandstone.webp";
...
const patterns = [
  { name: "Pattern 1", stone: "Katni Yellow", img: "/img/product/Stone Products/Katni Yellow Sandstone/Patterns/Lalitpur-yellow-sandstone-03.webp", desc: "Finest yellow sandstone with excellent aesthetic value.", swatch: "#C2A370", type: "Natural", complexity: "High", bestFor: "Exterior Paving" },
  { name: "Pattern 2", stone: "Katni Yellow", img: "/img/product/Stone Products/Katni Yellow Sandstone/Patterns/Lalitpur-yellow-sandstone-04.webp", desc: "Perfect finish with no minute defects.", swatch: "#B89B66", type: "Smooth Finish", complexity: "Medium", bestFor: "Kitchen Counters" }
];

const MARBLE_TEXTURE = patterns[0].img;

const galleryImages = [
  "/img/product/Stone Products/Katni Yellow Sandstone/Lalitpur-yellow-sandstone-02.webp",
  "/img/product/Stone Products/Katni Yellow Sandstone/Lalitpur-yellow-sandstone.webp",
  "/img/product/Stone Products/Katni Yellow Sandstone/Patterns/Lalitpur-yellow-sandstone-03.webp",
  "/img/product/Stone Products/Katni Yellow Sandstone/Patterns/Lalitpur-yellow-sandstone-04.webp",
  "/img/product/Stone Products/Katni Yellow Sandstone/Lalitpur-yellow-sandstone-02.webp",
  "/img/product/Stone Products/Katni Yellow Sandstone/Lalitpur-yellow-sandstone.webp"
];
...
const steps = [
  ...
  { title: "Stock Maintenance", body: "We maintain a large stock of Katni yellow sandstones to fulfill orders of any quantity." },
];

const LENS_SIZE = 180;
const ZOOM = 2.4;

const KatniYellowSandstoneView = () => {
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-6">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              STONE INDIA offers the finest Katni yellow sandstone available in the market for our clients. We make use of highly advanced and precision cutting machines during the manufacturing process and these stones are available in various thicknesses and sizes. Our stones are widely perceived as the most refined ones and many people become eloquent when they talk about aesthetic value and sturdiness.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-14 max-w-4xl mx-auto text-center">
            <p className="text-[15px] text-[#666] leading-[1.85] font-light mb-4">
              The positive feedback of our existing clients gives us immense satisfaction and we offer quality advice on how to maintain the stone effectively. You can order whatever quantity you want because we maintain a large stock of katni yellow sandstones.
            </p>
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 border-t border-black/[0.08]">
            {stoneProductsData.sandstoneProducts
              .filter(item => item.title !== "Katni Yellow Sandstone")
              .map((item, idx) => (
              <Link
                key={idx}
...
export default KatniYellowSandstoneView;
