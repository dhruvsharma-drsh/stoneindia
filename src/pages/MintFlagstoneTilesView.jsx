// src/pages/MintFlagstoneTilesView.jsx
...
/* ── Asset pool ── */
const HERO_IMG = "/img/product/Stone Products/Gwalior Stone/Mint Flagstone Tiles/mint-flag-stone-tiles-1.webp"; 
const MARBLE_TEXTURE = "/img/finitures_texture.png";
const MOSAIC_TEASE = "/img/mosaics--products-tease.webp";

// Using only the specific images for Mint Flagstone Tiles
const galleryImages = [
  "/img/product/Stone Products/Gwalior Stone/Mint Flagstone Tiles/mint-flag-stone-tiles-02.webp",
  "/img/product/Stone Products/Gwalior Stone/Mint Flagstone Tiles/mint-flag-stone-tiles-03.webp",
  "/img/product/Stone Products/Gwalior Stone/Mint Flagstone Tiles/mint-flag-stone-tiles-1.webp",
  "/img/product/Stone Products/Gwalior Stone/Mint Flagstone Tiles/mint-flag-stone-tiles-2.webp",
  "/img/product/Stone Products/Gwalior Stone/Mint Flagstone Tiles/mint-flag-stone-tiles.webp",
  "/img/product/Stone Products/Gwalior Stone/Mint Flagstone Tiles/Patterns/mint-flag-stone-tiles-05.webp",
  "/img/product/Stone Products/Gwalior Stone/Mint Flagstone Tiles/Patterns/mint-flag-stone-tiles-06.webp",
];
...
const patterns = [
  { name: "Natural Cut", stone: "Flagstone Tiles", img: "/img/product/Stone Products/Gwalior Stone/Mint Flagstone Tiles/Patterns/mint-flag-stone-tiles-3.webp", desc: "Naturally cleft tiles with distinct edges, providing an organic and earthy appearance.", swatch: "#C2CBBA", type: "Natural", complexity: "Low", bestFor: "Pathways" },
  { name: "Sawn Edge", stone: "Flagstone Tiles", img: "/img/product/Stone Products/Gwalior Stone/Mint Flagstone Tiles/Patterns/mint-flag-stone-tiles-4.webp", desc: "Clean sawn edges crafted with modern technology for a sharp, seamless fit.", swatch: "#B5BCAD", type: "Sawn", complexity: "Medium", bestFor: "Patios" },
  { name: "Antique Finish", stone: "Flagstone Tiles", img: "/img/product/Stone Products/Gwalior Stone/Mint Flagstone Tiles/Patterns/mint-flag-stone-tiles-05.webp", desc: "A smooth, worn finish giving an aged character that retains freshness over time.", swatch: "#A1A89A", type: "Antique", complexity: "Medium", bestFor: "Interiors" },
  { name: "Tumbled Finish", stone: "Flagstone Tiles", img: "/img/product/Stone Products/Gwalior Stone/Mint Flagstone Tiles/Patterns/mint-flag-stone-tiles-06.webp", desc: "Softened edges and a gently textured surface providing a rustic yet refined look.", swatch: "#92988C", type: "Tumbled", complexity: "High", bestFor: "Exteriors" },
];

const features = [
  { title: "Highest Quality", body: "Hand-selected and processed using the most updated technology to ensure perfection." },
  { title: "Naturally Quarried", body: "Be assured of 100% natural quarried limestone sourced from the best mines." },
  { title: "Not Reconstituted", body: "Enjoy authentic, solid stone that retains its freshness for a very long period of time." },
  { title: "Eco-Friendly", body: "Responsibly manufactured using environmentally friendly and sustainable processes." },
  { title: "Unbeatable Value", body: "High-quality products delivered through customer-friendly processes for maximum value." }
];

const LENS_SIZE = 180;
const ZOOM = 2.4;

const MintFlagstoneTilesView = () => {
    ...
    <div ref={pageRef} className="bg-[#FAFAF8] min-h-[100svh] font-sans text-[#111]">
      ...
      <section className="relative h-[80vh] md:h-[90vh] w-full overflow-hidden bg-[#111]">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-end sm:justify-center text-center px-4 sm:px-6 pb-20 sm:pb-0 max-w-5xl mx-auto pt-20">
          ...
          <p ref={heroSubRef} className="opacity-0 text-sm sm:text-lg md:text-2xl text-white/80 font-light max-w-2xl mx-auto leading-relaxed mb-6 sm:mb-10">
            Our exclusive mint flagstone tiles are the best choice available in their own kind, sourced from the best mines with distinct edges.
          </p>
      ...
      <div className="bg-white border-b border-[#EDEDE9] py-4 sticky top-0 z-40 backdrop-blur-xl bg-white/90">
        <div className="max-w-7xl mx-auto px-6 flex items-center gap-2 text-xs font-mono uppercase tracking-widest text-[#888]">
          ...
          <ChevronRight size={12} />
          <span className="text-[#B8955D] font-bold">Mint Flagstone Tiles</span>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-6">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              Our exclusive mint flagstone tiles are the best choice available in their own kind. STONE INDIA offers highly beautiful and extremely durable mint flagstone tiles that meet your requirements in the best possible manner. Sourced from the best mines, these tiles come with distinct edges and they retain the freshness for a very long period of time.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              Our price tag can be described as eye-watering and they make you jump with joy when you see the benefits associated. These products are available in a wide range of colors, patterns, styles, and designs and, you can choose the most congenial one based on your unique requirements.
            </p>
          ...
          <div className="split-right relative aspect-square lg:aspect-[4/5] rounded-3xl overflow-hidden bg-[#FAFAF8] border border-[#EDEDE9] shadow-[0_20px_60px_rgba(0,0,0,0.08)] flex flex-col justify-center gap-4 sm:gap-5 py-6">
            ...
            <div className="flex gap-4 sm:gap-5 w-max animate-marquee" style={{ animationDuration: '50s', animationDirection: 'reverse' }}>
              {[
                "/img/product/Stone Products/Gwalior Stone/Mint Flagstone Tiles/Patterns/mint-flag-stone-tiles-3.webp",
                "/img/product/Stone Products/Gwalior Stone/Mint Flagstone Tiles/Patterns/mint-flag-stone-tiles-4.webp",
                "/img/product/Stone Products/Gwalior Stone/Mint Flagstone Tiles/Patterns/mint-flag-stone-tiles-05.webp",
                "/img/product/Stone Products/Gwalior Stone/Mint Flagstone Tiles/Patterns/mint-flag-stone-tiles-06.webp",
                "/img/product/Stone Products/Gwalior Stone/Mint Flagstone Tiles/mint-flag-stone-tiles.webp",
                "/img/product/Stone Products/Gwalior Stone/Mint Flagstone Tiles/Patterns/mint-flag-stone-tiles-3.webp"
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center reveal-block">
          <div className="split-left">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light mb-5">
              Hover over the stone to inspect the extremely durable quality and distinct edges up close —
              the same freshness and premium quality that makes our mint flagstone highly sought after.
            </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light max-w-3xl mx-auto">
              As a responsible and dedicated mint flagstones tiles manufacturer and supplier, we make use of most updated technology in the manufacturing process and several quality checks are conducted to make sure that the products reach the customers faultless. Our philosophy is to deliver high-quality products with great commitment and dedication.
            </p>
          </div>
      ...
      <section className="reveal-block py-20 sm:py-28 px-6 pb-32">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex gap-6 overflow-x-auto snap-x snap-mandatory pb-4 -mx-6 px-6 lg:mx-0 lg:px-0 lg:grid lg:grid-cols-5 lg:overflow-visible">
            {features.map((s, i) => (
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 border-t border-black/[0.08]">
            {stoneProductsData.grid
              .filter(item => item.title !== "Mint Flagstone Tiles" && item.title !== "Mint Flagstones")
              .slice(0, 8)
              .map((item, idx) => (
              <Link
                key={idx}
      ...
      <section id="contact" className="relative py-32 flex items-center justify-center overflow-hidden bg-[#111]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center flex flex-col items-center">
          ...
          <h2 className="text-2xl sm:text-4xl md:text-6xl font-serif text-white mb-6 sm:mb-8">
            Elevate Your <span className="italic font-light">Interiors & Exteriors</span>
          </h2>
          <p className="text-lg md:text-xl text-white/70 font-light max-w-2xl mx-auto mb-10 leading-relaxed">
            Our exclusive mint flagstone tiles are available at customer-friendly prices. We've been delivering high-quality products for the last two decades.
          </p>
...
export default MintFlagstoneTilesView;
