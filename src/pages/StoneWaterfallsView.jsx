...
const HERO_IMG = "/img/product/Stone Products/Stone Waterfalls/image.png";
const TEXTURE_IMG = "/img/product/Stone Products/Stone Waterfalls/image copy.png";
const CTA_IMG = "/img/product/Stone Products/Stone Waterfalls/image copy 3.png";
...
const galleryImages = [
  "/img/product/Stone Products/Stone Waterfalls/image.png",
  "/img/product/Stone Products/Stone Waterfalls/image copy.png",
  "/img/product/Stone Products/Stone Waterfalls/image copy 2.png",
  "/img/product/Stone Products/Stone Waterfalls/image copy 3.png",
];

const featuresList = [
  { text: "Good for waterfall decoration" },
  { text: "Overall ambiance is enhanced" },
  { text: "100% Defect-free" },
  { text: "Maintain international parameters" },
  { text: "Optimum finish and outstanding design" },
];

const applicationsList = [
  { text: "Indoor waterfalls" },
  { text: "Garden water features" },
  { text: "Poolside natural cascades" },
  { text: "Landscape decorating purposes" },
];

const steps = [
  { title: "Talented Design", body: "Our supremely talented professionals have been designing high-quality waterfall stones for over two decades." },
  { title: "Systematic Manufacturing", body: "Everything is done in a systematic manner that goes well with international parameters and guidelines." },
  { title: "Quality Assurance", body: "Our stone waterfalls are guaranteed to be 100% defect-free ensuring excellent quality and performance." },
  { title: "Seamless Delivery", body: "We satisfy our customers by combining premium quality, affordability, and fast delivery harmoniously." },
];

const LENS_SIZE = 180;
const ZOOM = 2.4;

const StoneWaterfallsView = () => {
    ...
    <div ref={pageRef} className="bg-[#FAFAF8] min-h-[100svh] font-sans text-[#111]">
      ...
      <section className="relative h-[100svh] min-h-[500px] sm:min-h-[600px] w-full overflow-hidden bg-[#111]">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-end sm:justify-center text-center px-4 sm:px-6 pb-20 sm:pb-0 max-w-5xl mx-auto">
          ...
          <p ref={heroSubRef} className="opacity-0 text-sm sm:text-lg md:text-2xl text-white/80 font-light max-w-2xl mx-auto leading-relaxed mb-6 sm:mb-10">
            Elevate your ambiance to great heights with our defect-free, naturally crafted waterfall stones designed for the ultimate aesthetic appeal.
          </p>
      ...
      <div className="bg-[#FAFAF8] border-b border-[#EDEDE9] py-4 sticky top-0 z-40 backdrop-blur-xl bg-[#FAFAF8]/90">
        <div className="max-w-7xl mx-auto px-6 flex items-center gap-2 text-xs font-mono uppercase tracking-widest text-[#888]">
          ...
          <ChevronRight size={12} />
          <span className="text-[#B8955D] font-bold">Stone Waterfalls</span>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-6">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              Our supremely talented team of professionals has been designing high-quality waterfall stones for our customers for the past two decades. Our stone waterfalls are highly appreciated by a large number of people and, the outstanding design and optimum finish make our products the most sought after ones in the market.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              We strive hard to satisfy our customers by combining quality and affordability harmoniously, and our stone waterfalls lift the overall ambiance to great heights. You can achieve a completely natural look with the help of our stones and they have become the ultimate choice for waterfall decorating purposes.
            </p>
            <div className="pt-4">
      ...
      <section id="patterns" className="reveal-block py-20 sm:py-28 px-6 bg-[#FAFAF8]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-8">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              The vivacious appearance is inspiring but inimitable and you can expect fast delivery with us. Our stone waterfalls are 100% defect free and the way these stones are being manufactured goes well with international parameters and guidelines.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              We leave nothing to guesswork and everything is done in a systematic manner to ensure excellent quality. You can achieve a completely natural look with the help of our stones for your next project.
            </p>
          ...
          <div className="split-right relative aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl">
            <img src={galleryImages[1]} alt="Stone Waterfalls Nature Decor" className="w-full h-full object-cover" />
            ...
            <div className="absolute bottom-10 left-10 right-10 pointer-events-none">
              <h3 className="text-white font-serif text-3xl mb-3">Natural Serenity</h3>
              <p className="text-white/80 font-light text-sm">Achieve a completely natural look that lifts the overall ambiance.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 border-t border-black/[0.08]">
            {stoneProductsData.stoneArticrafts
              .filter(item => item.title !== "Stone Waterfalls")
              .map((item, idx) => (
              <Link
                key={idx}
...
export default StoneWaterfallsView;
