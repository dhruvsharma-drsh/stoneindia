...
const featuresList = [
  { text: "High crack resistance" },
  { text: "Unique design" },
  { text: "Optimum finish" },
];

const applicationsList = [
  { text: "Lawns and gardens" },
  { text: "Inside homes" },
  { text: "Terraces & porch areas" },
  { text: "Swimming pool areas" },
  { text: "Elevation areas" },
];

const steps = [
  { title: "Material Selection", body: "We source and use finely polished stones to ensure top quality for all our Indian stone figures." },
  { title: "Expert Designing", body: "Our expert designers utilize their extensive experience and advanced techniques to create breathtaking figures." },
  { title: "Quality Assurance", body: "We give our valuable customers the best assurance that our products meet every set parameter of quality control." },
  { title: "Versatile Styling", body: "Designed for a broad spectrum of figures in different sizes, shapes, and designs at unbeatable prices." },
];

const LENS_SIZE = 180;
const ZOOM = 2.4;

const StoneFiguresView = () => {
    ...
    <div ref={pageRef} className="bg-[#FAFAF8] min-h-[100svh] font-sans text-[#111]">
      ...
      <section className="relative h-[100svh] min-h-[500px] sm:min-h-[600px] w-full overflow-hidden bg-[#111]">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-end sm:justify-center text-center px-4 sm:px-6 pb-20 sm:pb-0 max-w-5xl mx-auto">
          ...
          <p ref={heroSubRef} className="opacity-0 text-sm sm:text-lg md:text-2xl text-white/80 font-light max-w-2xl mx-auto leading-relaxed mb-6 sm:mb-10">
            Top quality handicrafts and Indian stone figures created by expert designers using advanced techniques.
          </p>
      ...
      <div className="bg-[#FAFAF8] border-b border-[#EDEDE9] py-4 sticky top-0 z-40 backdrop-blur-xl bg-[#FAFAF8]/90">
        <div className="max-w-7xl mx-auto px-6 flex items-center gap-2 text-xs font-mono uppercase tracking-widest text-[#888]">
          ...
          <ChevronRight size={12} />
          <span className="text-[#B8955D] font-bold">Stone Figures</span>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-6">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              STONE INDIA is a colossal figure in the field of stone manufacturing industry. Our extensive experience and knowledge in manufacturing stone figures help us immensely in offering top quality handicrafts Indian stone figures. We always keep in mind the demands of our clients while producing these types of figures and our expert designers make use of finely polished stones and advanced techniques to create the best figures.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              The best assurance that we can give our valuable customers is that our products meet every set parameter of quality control.
            </p>
            <div className="pt-4">
      ...
      <section id="patterns" className="reveal-block py-20 sm:py-28 px-6 bg-[#FAFAF8]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-8">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              You can find a broad spectrum of figures in different sizes, designs, and shapes at unbeatable prices. Our stone figures come with optimum finish, unique design and high crack resistance.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              STONE INDIA stone figures are extensively used in a wide variety of applications. You can find these types of figures in lawns, inside homes, terraces, porch areas, swimming pool areas, elevation areas, gardens and so on.
            </p>
          ...
          <div className="split-right relative aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl">
            <img src={galleryImages[1]} alt="Stone Figures" className="w-full h-full object-cover" onLoad={(e) => {
            ...
            <div className="absolute bottom-10 left-10 right-10 pointer-events-none">
              <h3 className="text-white font-serif text-3xl mb-3">Masterful Artistry</h3>
              <p className="text-white/80 font-light text-sm">Finely polished stones carved into unique designs.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center reveal-block">
          <div className="split-left">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light mb-5">
              Hover over the stone figure to inspect the optimum finish, unique design, and expert craftsmanship up close —
              the same quality you'll find in every Stone India handicraft.
            </p>
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 border-t border-black/[0.08]">
            {stoneProductsData.stoneArticrafts
              .filter(item => item.title !== "Stone Figures")
              .map((item, idx) => (
              <Link
                key={idx}
      ...
      <section id="contact" className="relative py-32 flex items-center justify-center overflow-hidden bg-[#111]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center flex flex-col items-center">
          ...
          <p className="text-lg md:text-xl text-white/70 font-light max-w-2xl mx-auto mb-10 leading-relaxed">
            Available in bulk for wholesale buyers globally — the perfect choice for lawns, home interiors, terraces, and gardens.
          </p>
...
export default StoneFiguresView;
