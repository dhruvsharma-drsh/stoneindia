// src/pages/RainbowSandstoneView.jsx
...
const HERO_IMG = "/img/product/Stone Products/Rainbow Sandstone/Rainbow-Sandstone-03.webp";
...
const patterns = [
  { name: "Pattern 1", stone: "Rainbow", img: "/img/product/Stone Products/Rainbow Sandstone/Patterns/Rainbow-Sandstone.webp", desc: "Vibrant colors for outdoor character.", swatch: "#C28F79", type: "Natural", complexity: "Medium", bestFor: "Garden Patios" },
  { name: "Pattern 2", stone: "Rainbow", img: "/img/product/Stone Products/Rainbow Sandstone/Patterns/Rainbow-Sandstone-02.webp", desc: "Neat and smooth surface with unique shades.", swatch: "#B37A66", type: "Veneer Pattern", complexity: "High", bestFor: "Wall Cladding" }
];

const MARBLE_TEXTURE = patterns[0].img;

const galleryImages = [
  "/img/product/Stone Products/Rainbow Sandstone/Rainbow-Sandstone-04.webp",
  "/img/product/Stone Products/Rainbow Sandstone/Rainbow-Sandstone-03.webp",
  "/img/product/Stone Products/Rainbow Sandstone/Patterns/Rainbow-Sandstone.webp",
  "/img/product/Stone Products/Rainbow Sandstone/Patterns/Rainbow-Sandstone-02.webp",
  "/img/product/Stone Products/Rainbow Sandstone/Rainbow-Sandstone-04.webp",
  "/img/product/Stone Products/Rainbow Sandstone/Rainbow-Sandstone-03.webp"
];

const steps = [
  { title: "Vibrant Sourcing", body: "We source the finest rainbow sandstones known for their lively and vibrant colors." },
  { title: "Custom Sizing", body: "Offered in a wide variety of thicknesses and sizes to suit your specific needs." },
  { title: "Rigorous Quality", body: "Rigorous quality tests at all stages ensure all products are defect-free." },
  { title: "Large Inventory", body: "We maintain a huge stock to handle customer orders of any nature and size." },
];

const LENS_SIZE = 180;
const ZOOM = 2.4;

const RainbowSandstoneView = () => {
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-6">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              As the name suggests, our rainbow sandstones bring vibrant and lively colors to your patio and garden. If you want to add a character to your outdoor, you can use our products. Different shades have their uniqueness and they also come with a neat and smooth surface.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              STONE INDIA offers our products in a wide variety of thicknesses and sizes and you can choose the most suitable one you like most. There is no limitation when it comes to colors. As a trusted manufacturer and supplier, we conduct rigorous quality tests at all stages and this practice ensures that all our products are defect-free and fresh.
            </p>
            <div className="pt-4">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-14 max-w-4xl mx-auto text-center">
            <p className="text-[15px] text-[#666] leading-[1.85] font-light mb-4">
              We maintain a huge stock and can handle customer orders of any nature and size. Our clients come up with repeated orders and it is clearly a recognition for the quality of our products. In order to safeguard the interests of your clients, we have designed the best price stricture available in the market as well.
            </p>
            
            <div className="flex flex-wrap justify-center gap-4">
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Elegant look</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Smooth texture</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Veneer pattern</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Durable</span>
            </div>
          </div>
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 border-t border-black/[0.08]">
            {stoneProductsData.sandstoneProducts
              .filter(item => item.title !== "Rainbow Sandstone")
              .map((item, idx) => (
              <Link
                key={idx}
...
export default RainbowSandstoneView;
