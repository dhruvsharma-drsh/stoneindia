            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
              ...
              <div ref={heroCopyRef} className="flex flex-col gap-7">
                <div className="flex items-center gap-3">
                  <span className="w-10 h-[2px] bg-[#B7945D]"></span>
              ...
              <div ref={brandsCopyRef} className="flex flex-col gap-7 order-1 lg:order-2">
                ...
                <div className="pt-2 flex flex-wrap gap-4">
                  <a
                    ...
                    className="inline-flex items-center gap-3 px-8 py-4 rounded-full border-2 border-[#B4956C] text-[#B4956C] font-bold text-xs tracking-widest uppercase hover:bg-[#B7945D] hover:text-white transition-all duration-400 group"
                  >
        ...
        <section className="py-28 md:py-36">
          <div className="max-w-5xl mx-auto px-6 text-center">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <Link
                to="/contact"
                className="inline-flex items-center gap-3 px-10 py-5 rounded-full bg-[#111] text-white font-bold text-sm tracking-widest uppercase hover:bg-[#B7945D] transition-colors duration-400"
              >
