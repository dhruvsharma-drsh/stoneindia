...
/* ── Asset pool ── */
const HERO_IMG = "/img/product/Stone Products/Gwalior Stone/Gwalior Mint Cobbles/If you have been looking/Gwalior-mint-cobbles-1.webp"; 
const MARBLE_TEXTURE = "/img/finitures_texture.png";
const MOSAIC_TEASE = "/img/mosaics--products-tease.webp";

// Using only the specific images for Gwalior Mint Cobbles
const galleryImages = [
  "/img/product/Stone Products/Gwalior Stone/Gwalior Mint Cobbles/If you have been looking/Gawalior-mint-cobbles-11.jpg",
  "/img/product/Stone Products/Gwalior Stone/Gwalior Mint Cobbles/If you have been looking/Gawalior-mint-cobbles-12.jpg",
  "/img/product/Stone Products/Gwalior Stone/Gwalior Mint Cobbles/If you have been looking/Gwalior-mint-cobbles-1.webp",
  "/img/product/Stone Products/Gwalior Stone/Gwalior Mint Cobbles/If you have been looking/Gwalior-mint-cobbles-2.webp",
  "/img/product/Stone Products/Gwalior Stone/Gwalior Mint Cobbles/If you have been looking/Gwalior-mint-cobbles-3.webp",
  "/img/product/Stone Products/Gwalior Stone/Gwalior Mint Cobbles/Patterns/Gawalior-mint-cobbles-13.webp",
  "/img/product/Stone Products/Gwalior Stone/Gwalior Mint Cobbles/Patterns/Gawalior-mint-cobbles-14.webp",
];
...
const patterns = [
  { name: "Natural Split", stone: "Mint Cobbles", img: "/img/product/Stone Products/Gwalior Stone/Gwalior Mint Cobbles/Patterns/Gwalior-mint-cobbles-4.webp", desc: "Features an extremely smooth natural split surface ideal for authentic landscaping.", swatch: "#C2CBBA", type: "Natural", complexity: "Low", bestFor: "Pathways" },
  { name: "Tumbled Edge", stone: "Mint Cobbles", img: "/img/product/Stone Products/Gwalior Stone/Gwalior Mint Cobbles/Patterns/Gwalior-mint-cobbles-5.webp", desc: "Softened, tumbled finish that adds an antique touch to European styled gardens.", swatch: "#B5BCAD", type: "Tumbled", complexity: "Medium", bestFor: "Exteriors" },
  { name: "Sawn Finish", stone: "Mint Cobbles", img: "/img/product/Stone Products/Gwalior Stone/Gwalior Mint Cobbles/Patterns/Gawalior-mint-cobbles-13.webp", desc: "Clean, sawn cuts providing a more modern and structural layout.", swatch: "#A1A89A", type: "Sawn", complexity: "Medium", bestFor: "Commercial" },
  { name: "Polished Craft", stone: "Mint Cobbles", img: "/img/product/Stone Products/Gwalior Stone/Gwalior Mint Cobbles/Patterns/Gawalior-mint-cobbles-14.webp", desc: "Chiseled and dressed to a sleek surface, perfect for interior linings and pillars.", swatch: "#92988C", type: "Polished", complexity: "High", bestFor: "Interiors" },
];

const features = [
  { title: "Frost Resistance", body: "Maintains structural integrity even in freezing European climates." },
  { title: "Supreme Quality", body: "Carefully selected and processed to ensure premium international standards." },
  { title: "Weather Resistant", body: "Highly durable with strong resistance against harsh weather, acid, and heat." },
  { title: "Crushing Strength", body: "Offers high crushing strength making it ideal for heavy foot traffic and commercial landscapes." },
  { title: "Highly Craftable", body: "Extremely manageable and perfect for carving, handicrafts, and sculptures." }
];

const LENS_SIZE = 180;
const ZOOM = 2.4;

const GwaliorMintCobblesView = () => {
    ...
    <div ref={pageRef} className="bg-[#FAFAF8] min-h-[100svh] font-sans text-[#111]">
      ...
      <section className="relative h-[80vh] md:h-[90vh] w-full overflow-hidden bg-[#111]">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-end sm:justify-center text-center px-4 sm:px-6 pb-20 sm:pb-0 max-w-5xl mx-auto pt-20">
          ...
          <p ref={heroSubRef} className="opacity-0 text-sm sm:text-lg md:text-2xl text-white/80 font-light max-w-2xl mx-auto leading-relaxed mb-6 sm:mb-10">
            The popularity of Mint Cobbles is not hidden. These are the type of sandstones popular in European and non-European nations.
          </p>
      ...
      <div className="bg-white border-b border-[#EDEDE9] py-4 sticky top-0 z-40 backdrop-blur-xl bg-white/90">
        <div className="max-w-7xl mx-auto px-6 flex items-center gap-2 text-xs font-mono uppercase tracking-widest text-[#888]">
          ...
          <ChevronRight size={12} />
          <span className="text-[#B8955D] font-bold">Gwalior Mint Cobbles</span>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-6">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              The popularity of Mint Cobbles is not hidden. These are the type of sandstones popular in European and non-European nations. Gwalior Mint Cobbles are high in demand in Delhi for their unique physical and chemical properties. They are commonly used in flooring, wall fixing, and lining. The cobbles feature an extremely smooth natural split surface that makes them ideal for caving and handicrafts.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              The best feature of Mint Cobbles made in India is the availability of tailored thickness and various forms such as natural, tumbled, sawn, calibrated, polished, brushed, and antique finish. Cobbles paving is undoubtedly best for the exteriors. They are available in beautiful textures and hence the preferred choice when a person chooses a natural form of Gwalior mint cobbles.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              They offer the best look when polished and are used as garden and commercial landscapes, panels, pillars, sculptures, and arches.
            </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light max-w-3xl mx-auto">
              Smooth finish and weather resistant Gwalior Mint Sandstones are very popular, they can be chiseled and dressed to the sleek surface. We take a professional approach, maintain reliability, transparency and become competitive to accomplish your Mint cobbles project work.
            </p>
          </div>
            ...
            <div className="lg:col-span-8">
              <div className="relative aspect-[16/10] rounded-3xl overflow-hidden shadow-2xl mb-6 bg-black">
                ...
                <div className="absolute bottom-6 left-6 right-6 pointer-events-none">
                  <span className="text-white font-serif text-2xl lg:text-3xl block mb-2">{patterns[activePattern].name} Cobbles</span>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="bg-white border border-[#EDEDE9] rounded-xl p-4 text-center">
                  ...
                  <span className="text-[11px] text-[#888] font-medium">Finish</span>
                </div>
                <div className="bg-white border border-[#EDEDE9] rounded-xl p-4 text-center">
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 border-t border-black/[0.08]">
            {stoneProductsData.grid
              .filter(item => item.title !== "Gwalior Mint Cobbles" && item.title !== "Mint Cobbles")
              .slice(0, 8)
              .map((item, idx) => (
              <Link
                key={idx}
      ...
      <section id="contact" className="relative py-32 flex items-center justify-center overflow-hidden bg-[#111]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center flex flex-col items-center">
          ...
          <h2 className="text-2xl sm:text-4xl md:text-6xl font-serif text-white mb-6 sm:mb-8">
            Elevate Your <span className="italic font-light">Exteriors</span>
          </h2>
          <p className="text-lg md:text-xl text-white/70 font-light max-w-2xl mx-auto mb-10 leading-relaxed">
            Contact us to buy Mint Cobbles at a wholesale rate. We maintain reliability and transparency for your project work.
          </p>
