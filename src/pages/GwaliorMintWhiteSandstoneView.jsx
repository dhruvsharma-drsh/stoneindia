// src/pages/GwaliorMintWhiteSandstoneView.jsx
...
const HERO_IMG = "/img/product/Stone Products/Gwalior Mint White Sandstone/Gwalior-mint-white-sand-stone-1.webp";
const MOSAIC_TEASE = "/img/mosaics--products-tease.webp";
// MARBLE_TEXTURE moved below patterns
...
const patterns = [
  { name: "Pattern 1", stone: "Gwalior Mint White", img: "/img/product/Stone Products/Gwalior Mint White Sandstone/Patterns/Gwalior-Mint-White-Sandstone-02.webp", desc: "Available in natural, sandblast and honed finish.", swatch: "#E8E7DF", type: "Natural", complexity: "High", bestFor: "Interiors" },
  { name: "Pattern 2", stone: "Gwalior Mint White", img: "/img/product/Stone Products/Gwalior Mint White Sandstone/Patterns/Gwalior-Mint-White-Sandstone.webp", desc: "Perfect for making stone handicrafts and carvings.", swatch: "#D6D3CB", type: "Honed", complexity: "Medium", bestFor: "Exteriors" },
  { name: "Pattern 3", stone: "Gwalior Mint White", img: "/img/product/Stone Products/Gwalior Mint White Sandstone/Patterns/Gwalior-mint-white-sand-stone-5.webp", desc: "Available in both sides saw, both sides natural.", swatch: "#C2C0B8", type: "Sandblast", complexity: "Low", bestFor: "Home Decor" },
  { name: "Pattern 4", stone: "Gwalior Mint White", img: "/img/product/Stone Products/Gwalior Mint White Sandstone/Patterns/Gwalior-mint-white-sand-stone-6.webp", desc: "Outstanding performance, high saline water resistance.", swatch: "#AFAEA7", type: "Polished", complexity: "High", bestFor: "Pathways" },
  { name: "Pattern 5", stone: "Gwalior Mint White", img: "/img/product/Stone Products/Gwalior Mint White Sandstone/Patterns/Gwalior-mint-white-sand-stone-7.webp", desc: "Superior mechanical strength, extreme resistance to weather.", swatch: "#9C9A95", type: "Natural", complexity: "Medium", bestFor: "Facades" }
];

const MARBLE_TEXTURE = patterns[0].img;

const galleryImages = [
  "/img/product/Stone Products/Gwalior Mint White Sandstone/Gwalior-Mint-White-Sandstone-03.webp",
  "/img/product/Stone Products/Gwalior Mint White Sandstone/Gwalior-Mint-White-Sandstone-04.webp",
  "/img/product/Stone Products/Gwalior Mint White Sandstone/Gwalior-mint-white-sand-stone-1.webp",
  "/img/product/Stone Products/Gwalior Mint White Sandstone/Gwalior-mint-white-sand-stone-2.webp",
  "/img/product/Stone Products/Gwalior Mint White Sandstone/Gwalior-mint-white-sand-stone-3.webp",
  "/img/product/Stone Products/Gwalior Mint White Sandstone/Gwalior-mint-white-sand-stone-4 (1).webp"
];

const steps = [
  { title: "Block Selection", body: "Our Gwalior Mint Sand Stone is manufactured with high-quality blocks." },
  { title: "Customization", body: "We customize the range according to the requirements of our clients in different sizes." },
  { title: "Precision Finishing", body: "Available on both sides saw, both sides natural, one side natural and one side polished." },
  { title: "Quality Assurance", body: "Ensuring amazing water resistance, dynamic low water absorption, and outstanding mechanical strength." },
];

const LENS_SIZE = 180;
const ZOOM = 2.4;

const GwaliorMintWhiteSandstoneView = () => {
  ...
  return (
    <div ref={pageRef} className="bg-[#FAFAF8] min-h-[100svh] font-sans text-[#111]">
      ...
      <section className="relative h-[100svh] min-h-[500px] sm:min-h-[600px] w-full overflow-hidden bg-[#111]">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-end sm:justify-center text-center px-4 sm:px-6 pb-20 sm:pb-0 max-w-5xl mx-auto">
          <div ref={heroBadgeRef} className="opacity-0 inline-flex items-center gap-2 px-5 py-2 rounded-full border border-white/20 bg-white/5 backdrop-blur-md mb-8">
            ...
            <span className="text-xs tracking-[0.2em] text-[#DFBA73] font-bold uppercase">Artisanal Collection</span>
          </div>
          ...
          <p ref={heroSubRef} className="opacity-0 text-sm sm:text-lg md:text-2xl text-white/80 font-light max-w-2xl mx-auto leading-relaxed mb-6 sm:mb-10">
            If you have been looking for the best quality Gwalior Mint Sand Stone, you can trust Stone India.
          </p>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-6">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif text-[#111] leading-[1.2]">
              If you have been looking for the best quality <span className="text-[#B8955D] italic">Gwalior Mint Sand Stone</span>, you can trust Stone India.
            </h2>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              As a committed processor and supplier of natural stones, STONE INDIA offers a broad spectrum of products to go well with the varying requirements of different clients. Our Gwalior mint white stones always stand tall among the most popular products. They are available in different dimensions, finish, patterns, designs, colors, and sizes.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              Our Gwalior Mint Sand Stone is manufactured with the high-quality blocks and you can maintain them with absolute ease and comfort. We customize the range according to the requirements of our clients. Both national and international clients have been showing genuine interest when it comes to choosing our products.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              The most important features of these stones are outstanding performance, high saline water resistance, superior mechanical strength, extreme resistance to weather and low water absorption as well. You can use our stones for both interiors as well as exterior décor and the elegant look of these stones has always been a hot topic of discussion among many people.
            </p>
            <div className="pt-4">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center reveal-block">
          <div className="split-left">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light mb-5">
              ...
              the same detail you'll find in every finished piece.
            </p>
      ...
      ══════════════════════════════════════ */}
      <section className="reveal-block py-20 sm:py-28 px-6 bg-[#FAFAF8]" id="patterns">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-serif text-[#111] leading-[1.2]">
              The Gwalior Mint Sand Stone <span className="text-[#B8955D] italic">For Home Décor</span>
            </h2>
          </div>
          
          <div className="mb-14 max-w-4xl mx-auto text-center">
            <p className="text-[15px] text-[#666] leading-[1.85] font-light mb-4">
              The Gwalior Mint Sand Stone can be used both for interior as well as for exterior décor and sizes can be ordered as per need. It is available in natural, sandblast and honed finish. Owing to its smooth finish it is used for making stone handicrafts and also for carvings. Talking about the surface finish, it is available on both sides saw, both sides natural, one side natural and one side polished. Talking about sizes, it is available in 30×30, 40×40, 60×30, 60×60, 60×40, 60×90 Cut to size Tiles.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light mb-8">
              The most important benefits of our products include excellent performance, amazing water resistance, dynamic low water absorption and outstanding mechanical strength as well. You can use our products for both exterior décor and interior décor.
            </p>
            
            <div className="flex flex-wrap justify-center gap-4">
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Weather resistant</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Superior performance</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Tensile mechanical strength</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Low absorption of water</span>
            </div>
          </div>
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 border-t border-black/[0.08]">
            {stoneProductsData.sandstoneProducts
              .filter(item => item.title !== "Gwalior Mint White Sandstone")
              .map((item, idx) => (
              <Link
                key={idx}
      ...
      <section className="reveal-block py-20 sm:py-28 px-6 pb-32">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-serif text-[#111] leading-[1.2]">
              From Quarry to <span className="text-[#B8955D] italic">Finished Product</span>
            </h2>
          </div>
...
export default GwaliorMintWhiteSandstoneView;
