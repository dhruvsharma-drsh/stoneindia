...
const HERO_IMG = "/img/product/Stone Products/Stone Planters/image.png";
const TEXTURE_IMG = "/img/product/Stone Products/Stone Planters/image copy.png";
const CTA_IMG = "/img/product/Stone Products/Stone Planters/image copy 3.png";
...
const galleryImages = [
  "/img/product/Stone Products/Stone Planters/image.png",
  "/img/product/Stone Products/Stone Planters/image copy.png",
  "/img/product/Stone Products/Stone Planters/image copy 2.png",
  "/img/product/Stone Products/Stone Planters/image copy 3.png",
];

const featuresList = [
  { text: "Stunning and attractive" },
...
const applicationsList = [
  { text: "Outdoor gardens & lawns" },
  { text: "Indoor home decor" },
  { text: "Patios & terraces" },
  { text: "Commercial spaces" },
];

const steps = [
  { title: "Creative Crafting", body: "Our skilled craftsmen utilize their incredible creative skills to produce stunningly attractive planters." },
  { title: "Material Selection", body: "We use premium natural stones valued for their extreme durability, strength, and crack-resistance." },
  { title: "Quality Standards", body: "We strictly keep up with international standards in terms of quality control and aesthetic appeal." },
  { title: "Advanced Processing", body: "The most advanced tools are employed to process the products to perfection with custom options available." },
];

const LENS_SIZE = 180;
const ZOOM = 2.4;

const StonePlantersView = () => {
    ...
    <div ref={pageRef} className="bg-[#FAFAF8] min-h-screen font-sans text-[#111]">
      ...
      <section className="relative h-screen w-full overflow-hidden bg-[#111]">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6 max-w-5xl mx-auto">
          ...
          <p ref={heroSubRef} className="opacity-0 text-lg md:text-2xl text-white/80 font-light max-w-2xl mx-auto leading-relaxed mb-10">
            Amazingly superior stone planters crafted to give your imagination free wings and last for a lifetime.
          </p>
      ...
      <div className="bg-[#FAFAF8] border-b border-[#EDEDE9] py-4 sticky top-0 z-40 backdrop-blur-xl bg-[#FAFAF8]/90">
        <div className="max-w-7xl mx-auto px-6 flex items-center gap-2 text-xs font-mono uppercase tracking-widest text-[#888]">
          ...
          <ChevronRight size={12} />
          <span className="text-[#B8955D] font-bold">Stone Planters</span>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-6">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              If you are looking for the best stone planters in the market, you can purchase from us. STONE INDIA, as an accomplished and reliable stone planter manufacturer, provides amazingly superior products that last for a very long time. Our skilled craftsmen make use of their unbelievable creative skills to produce stunningly attractive stone planters.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              We keep up with international standards in terms of quality and the aesthetic appeal of these planters offer free wings to your imagination. Our stones are valued for their durability and strength and, we have a huge stock of different types of stone planters.
            </p>
            <div className="pt-4">
      ...
      <section id="patterns" className="reveal-block py-20 sm:py-28 px-6 bg-[#FAFAF8]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-8">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              You have the freedom to choose the one that fits your needs from the wide range of patterns, styles, and designs. You can clean our planters with great ease and they are available at pocket-friendly prices.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              The most advanced tools are employed to process the products, and STONE INDIA also offers customized products upon special request to match your specific garden or interior decor needs.
            </p>
          ...
          <div className="split-right relative aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl">
            ...
            <div className="absolute bottom-10 left-10 right-10 pointer-events-none">
              ...
              <p className="text-white/80 font-light text-sm">Providing wings to your imagination with stunning planters.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="contact" className="relative py-32 flex items-center justify-center overflow-hidden bg-[#111]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center flex flex-col items-center">
          ...
          <p className="text-lg md:text-xl text-white/70 font-light max-w-2xl mx-auto mb-10 leading-relaxed">
            Beautifully crafted natural stone planters available in bulk for wholesale buyers globally. Upgrade your outdoor spaces with our premium quality.
          </p>
