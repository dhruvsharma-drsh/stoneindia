// src/pages/TeakwoodSandstoneView.jsx
...
const patterns = [
  { name: "Pattern 1", stone: "Teakwood", img: "/img/product/Stone Products/Teakwood Sandstone/Patterns/Teakwood-Sandstone.webp", desc: "Smooth light yellow veined sandstone.", swatch: "#E1CD97", type: "Natural", complexity: "Medium", bestFor: "Pool Surrounds" },
  { name: "Pattern 2", stone: "Teakwood", img: "/img/product/Stone Products/Teakwood Sandstone/Patterns/Teakwood-Sandstone-02.webp", desc: "Bold colors with a wood-like texture.", swatch: "#D6B878", type: "Split Surface", complexity: "High", bestFor: "Wall Cladding" }
];

const MARBLE_TEXTURE = patterns[0].img;

const galleryImages = [
  "/img/product/Stone Products/Teakwood Sandstone/Teakwood-Sandstone-03.jpg",
  "/img/product/Stone Products/Teakwood Sandstone/Teakwood-Sandstone-04.webp",
  "/img/product/Stone Products/Teakwood Sandstone/Patterns/Teakwood-Sandstone.webp",
  "/img/product/Stone Products/Teakwood Sandstone/Patterns/Teakwood-Sandstone-02.webp",
  "/img/product/Stone Products/Teakwood Sandstone/Teakwood-Sandstone-04.webp",
  "/img/product/Stone Products/Teakwood Sandstone/Teakwood-Sandstone-03.jpg"
];

const steps = [
  { title: "Stone Sourcing", body: "We source the best teakwood sandstone with smooth, light yellow veins." },
  { title: "Surface Finishing", body: "The stones are polished to offer a fine surface finish resembling wood." },
  { title: "Quality Checks", body: "We perform stringent quality checks to ensure supreme quality." },
  { title: "Delivery", body: "Delivering a unique appearance with firm and non-slip underfoot." },
];

const LENS_SIZE = 180;
const ZOOM = 2.4;

const TeakwoodSandstoneView = () => {
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-6">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              Our teakwood sandstone products are smooth light yellow veined sandstones that offer a distinct look. A blended appearance can always be associated with our products and they are extremely durable.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              If you are looking for a perfect option for the outdoors, especially, pool surrounds; you do not have to think about any other choice available in the market. Our teakwood stones are the best option that you can ever come across. The flamboyant and bold color makes a real statement and it comes with firm and non slip underfoot. The texture is really inviting and it clearly resembles the texture of wood.
            </p>
            <div className="pt-4">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-14 max-w-4xl mx-auto text-center">
            <p className="text-[15px] text-[#666] leading-[1.85] font-light mb-4">
              All our teakwood sandstones are extremely affordable because of our unbeatable pricing structure. The functionality and aesthetic appeal go hand in hand and, no two slabs are ever the same to deliver a completely unique appearance. We perform stringent quality checks to ensure supreme quality and our best manufacturing practices ensure finest longevity and excellent performance.
            </p>
            
            <div className="flex flex-wrap justify-center gap-4">
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Attractive colours</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Polished look</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Fine surface finish</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Easy to maintain</span>
            </div>
          </div>
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 border-t border-black/[0.08]">
            {stoneProductsData.sandstoneProducts
              .filter(item => item.title !== "Teakwood Sandstone")
              .map((item, idx) => (
              <Link
                key={idx}
...
export default TeakwoodSandstoneView;
