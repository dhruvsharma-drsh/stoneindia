// src/pages/MintFossilIndianSandstoneView.jsx
...
const HERO_IMG = "/img/product/Mint Fossil Indian Sandstone/Mint-Fossil-Indian-Sandstone.webp";
...
const patterns = [
  { name: "Pattern 1", stone: "Mint Fossil", img: "/img/product/Mint Fossil Indian Sandstone/patterns/Mint-Fossil-Indian-Sandstone-02.webp", desc: "Lightly riven surface with vibrant fossil marks.", swatch: "#D9C9A1", type: "Natural", complexity: "High", bestFor: "Garden Patios" },
  { name: "Pattern 2", stone: "Mint Fossil", img: "/img/product/Mint Fossil Indian Sandstone/patterns/Mint-Fossil-Indian-Sandstone-03.webp", desc: "Off-white cream to yellow shades with unique patterns.", swatch: "#E0D2B4", type: "Split Surface", complexity: "Medium", bestFor: "Interior Floors" }
];

const MARBLE_TEXTURE = patterns[0].img;

const galleryImages = [
  "/img/product/Mint Fossil Indian Sandstone/Mint-Fossil-Indian-Sandstone-04.webp",
  "/img/product/Mint Fossil Indian Sandstone/Mint-Fossil-Indian-Sandstone.webp",
  "/img/product/Mint Fossil Indian Sandstone/patterns/Mint-Fossil-Indian-Sandstone-02.webp",
  "/img/product/Mint Fossil Indian Sandstone/patterns/Mint-Fossil-Indian-Sandstone-03.webp",
  "/img/product/Mint Fossil Indian Sandstone/Mint-Fossil-Indian-Sandstone.webp",
  "/img/product/Mint Fossil Indian Sandstone/patterns/Mint-Fossil-Indian-Sandstone-02.webp"
];

const steps = [
  { title: "Stone Selection", body: "We source the finest Mint Fossil Indian sandstone with distinct fossil marks and vibrant tones." },
  { title: "Surface Processing", body: "Our professionals process the stone to bring appealing shape and texture." },
  { title: "Hand-Cut Edges", body: "Stones are carefully prepared with hand-cut dressed edges for a unique charm." },
  { title: "Quality Delivery", deliver: "Delivered in various sizes and finishes like polished, honed, sawn, and sandblasted." },
];

const LENS_SIZE = 180;
const ZOOM = 2.4;

const MintFossilIndianSandstoneView = () => {
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-6">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              Mint Fossil Indian sandstone is our most popular stone product with split surface and dressed edges that come at an economical price. With its lightly riven surface, it gives a combination of colors with fossil marks and vibrant tones making it the best fossil mint sandstone in India. Mint fossil Indian sandstone gives an appealing look on both smaller and larger areas. It is aesthetically fit for laying paving where depth restrictions occur, it enables a more accurate level working to make laying simpler.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              Mint Fossil Indian sandstone is hard to wear preventing the loss of color or surface even after several years of use. Paving displays predominant tones create an off-white cream to off-white yellow shades with unique patterns, tonal variations and nominal differences in color to provide a unique charm. Fossil mint Indian sandstones have major applications in exterior areas such as in garden patios as well as interior stone floors. It comes in various finishes such as polished, honed, sawn, sandblasted etc.
            </p>
            <div className="pt-4">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-14 max-w-4xl mx-auto text-center">
            <p className="text-[15px] text-[#666] leading-[1.85] font-light mb-4">
              These sandstones are appreciated for their significant features like longer service life, durability and economical price. Our experienced professionals process the high-quality Mint Fossil Indian sandstone to bring appealing shape and texture. These stones are widely used in decorating the outdoors, walls, floor, footpaths, and pavements. Considering the varying demands of our clients, we deliver fossil stones in various sizes and textures.
            </p>
            
            <div className="flex flex-wrap justify-center gap-4">
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Add timeless charm</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Natural colors & textures</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Unique quality</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Hand-cut edges</span>
            </div>
          </div>
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 border-t border-black/[0.08]">
            {stoneProductsData.sandstoneProducts
              .filter(item => item.title !== "Mint Fossil Indian Sandstone")
              .map((item, idx) => (
              <Link
                key={idx}
...
export default MintFossilIndianSandstoneView;
