// src/pages/GwaliorMintYellowSandstoneView.jsx
...
const HERO_IMG = "/img/product/Stone Products/Gwalior Mint Yellow Sandstone/gwalior-mint-yellow-sand-stone-1.webp";
...
const patterns = [
  { name: "Pattern 1", stone: "Gwalior Mint Yellow", img: "/img/product/Stone Products/Gwalior Mint Yellow Sandstone/Patterns/Gwalior-Mint-Yellow-Sandstone02.webp", desc: "A classy and elegant choice for both interior and exterior decor.", swatch: "#D4C7A3", type: "Natural", complexity: "High", bestFor: "Interiors" },
  { name: "Pattern 2", stone: "Gwalior Mint Yellow", img: "/img/product/Stone Products/Gwalior Mint Yellow Sandstone/Patterns/Gwalior-Mint-Yellow-Sandstone03.webp", desc: "Smooth natural split surface, weather resistant.", swatch: "#CAB180", type: "Split Surface", complexity: "Medium", bestFor: "Paving" },
  { name: "Pattern 3", stone: "Gwalior Mint Yellow", img: "/img/product/Stone Products/Gwalior Mint Yellow Sandstone/Patterns/gwalior-mint-yellow-sand-stone-4.webp", desc: "Rich visual appeal that adds grace and classy appeal.", swatch: "#C0A66E", type: "Natural", complexity: "Low", bestFor: "Flooring" },
  { name: "Pattern 4", stone: "Gwalior Mint Yellow", img: "/img/product/Stone Products/Gwalior Mint Yellow Sandstone/Patterns/gwalior-mint-yellow-sand-stone-5.webp", desc: "Resistant to acid and thermal resistance.", swatch: "#E1D2B3", type: "Shot Blasted", complexity: "High", bestFor: "Wall Cladding" },
  { name: "Pattern 5", stone: "Gwalior Mint Yellow", img: "/img/product/Stone Products/Gwalior Mint Yellow Sandstone/Patterns/gwalior-mint-yellow-sand-stone-6.webp", desc: "Processed using fully automatic edge cutting and calibration.", swatch: "#DCC391", type: "Calibrated", complexity: "Medium", bestFor: "Artifacts" }
];

const MARBLE_TEXTURE = patterns[0].img;

const galleryImages = [
  "/img/product/Stone Products/Gwalior Mint Yellow Sandstone/Gwalior-Mint-Yellow-Sandstone.webp",
  "/img/product/Stone Products/Gwalior Mint Yellow Sandstone/Gwalior-Mint-Yellow-Sandstone04.webp",
  "/img/product/Stone Products/Gwalior Mint Yellow Sandstone/gwalior-mint-yellow-sand-stone-1.webp",
  "/img/product/Stone Products/Gwalior Mint Yellow Sandstone/gwalior-mint-yellow-sand-stone-2.webp",
  "/img/product/Stone Products/Gwalior Mint Yellow Sandstone/gwalior-mint-yellow-sand-stone-3.webp",
  "/img/product/Stone Products/Gwalior Mint Yellow Sandstone/Patterns/Gwalior-Mint-Yellow-Sandstone02.webp"
];

const steps = [
  { title: "Material Selection", body: "We use the latest machines to ensure the highest quality of Gwalior Mint Yellow sandstones." },
  { title: "Processing", body: "Processed with fully automatic edge cutting, calibration, shot blasting, engraving and tumbling equipment." },
  { title: "Quality Control", body: "Our quality control team ensures impeccability in the range for excellence and durability." },
  { title: "Final Polish", body: "Different surface finishes are achieved to meet demands across the world." },
];

const LENS_SIZE = 180;
const ZOOM = 2.4;

const GwaliorMintYellowSandstoneView = () => {
      ...
      <section className="relative h-[100svh] min-h-[500px] sm:min-h-[600px] w-full overflow-hidden bg-[#111]">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-end sm:justify-center text-center px-4 sm:px-6 pb-20 sm:pb-0 max-w-5xl mx-auto">
          ...
          <p ref={heroSubRef} className="opacity-0 text-sm sm:text-lg md:text-2xl text-white/80 font-light max-w-2xl mx-auto leading-relaxed mb-6 sm:mb-10">
            If you have been looking for the best quality Natural Stone, you can trust Stone India.
          </p>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="split-left space-y-6">
            ...
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              Gwalior Mint Yellow Sandstones are made in perfect finish and design, developed to perfection. Our quality control team ensures impeccability in the range. We are a popular manufacturer and supplier of Gwalior Mint Yellow Sandstones made to ensure impeccability in the range. The supreme quality mint Yellow sandstones are popular for their excellence and durability. These stones are resistant to acid and thermal resistance. The incomparable features of this stone help us create a wider market.
            </p>
            <p className="text-[15px] text-[#666] leading-[1.85] font-light">
              Mint Yellow sandstones have a smooth natural split surface, they are weather resistant that makes them an ideal building and paving material. With extreme beauty, these sandstones are the preferable and economical choice for flooring, wall cladding, garden feature, artifacts, and more.
            </p>
            <div className="pt-4">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-serif text-[#111] leading-[1.2]">
              Yellow sandstones in different finishes are a classy <span className="text-[#B8955D] italic">and elegant choice</span>
            </h2>
          </div>
          
          <div className="mb-14 max-w-4xl mx-auto text-center">
            <p className="text-[15px] text-[#666] leading-[1.85] font-light mb-4">
              Yellow sandstones in different finishes are a classy and elegant choice for both interior and exterior decor. They are chemically resistant Mono-minerallic rocks made of silica. Gwalior Mint Yellow sandstones have a natural surface finish and rich visual appeal that adds grace and classy appeal. We are using latest machines such as fully automatic edge cutting, calibration, shot blasting, engraving and tumbling equipment. We cut and process sandstones in different surface finishes that are in demand across the world.
            </p>
            
            <div className="flex flex-wrap justify-center gap-4">
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Fully automatic edge cutting</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Calibration equipment</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Shot blasting</span>
              <span className="px-4 py-2 bg-white border border-[#EDEDE9] rounded-full text-sm font-medium text-[#B8955D] shadow-sm"><CheckCircle2 className="inline mr-2 w-4 h-4" /> Engraving & tumbling</span>
            </div>
          </div>
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 border-t border-black/[0.08]">
            {stoneProductsData.sandstoneProducts
              .filter(item => item.title !== "Gwalior Mint Yellow Sandstone")
              .map((item, idx) => (
              <Link
                key={idx}
...
export default GwaliorMintYellowSandstoneView;
